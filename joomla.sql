...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2013 a las 20:05:47
...
--
-- Estructura de tabla para la tabla `v2o6t_assets`
--

CREATE TABLE IF NOT EXISTS `v2o6t_assets` (
...
--
-- Volcado de datos para la tabla `v2o6t_assets`
--

INSERT INTO `v2o6t_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(8, 1, 30, 77, 1, 'com_content', 'com_content', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
...
(26, 1, 61, 78, 1, 'com_wrapper', 'com_wrapper', '{}'),
...
(35, 1, 83, 84, 1, 'com_hikashop', 'hikashop', '{}'),
(36, 8, 61, 64, 2, 'com_content.category.8', 'Videojuegos', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(37, 8, 65, 66, 2, 'com_content.category.9', 'Accesorios', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(38, 8, 67, 68, 2, 'com_content.category.10', 'Guias', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(39, 36, 62, 63, 3, 'com_content.article.1', 'Hola', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(40, 8, 69, 76, 2, 'com_content.category.11', 'Conoce la empresa', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(41, 40, 70, 71, 3, 'com_content.article.2', 'Mision Vision Valores', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(42, 40, 72, 73, 3, 'com_content.article.3', '¿Quienes somos?', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(43, 40, 74, 75, 3, 'com_content.article.4', 'Condiciones de compras', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_associations`
--

CREATE TABLE IF NOT EXISTS `v2o6t_associations` (
...
--
-- Estructura de tabla para la tabla `v2o6t_banners`
--

CREATE TABLE IF NOT EXISTS `v2o6t_banners` (
...
--
-- Estructura de tabla para la tabla `v2o6t_banner_clients`
--

CREATE TABLE IF NOT EXISTS `v2o6t_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `v2o6t_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `v2o6t_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `v2o6t_categories`
--

CREATE TABLE IF NOT EXISTS `v2o6t_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_categories`
--

INSERT INTO `v2o6t_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 21, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 572, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 175, 1, 1, 2, 1, 'principal', 'com_content', 'Principal', 'principal', '', '', -2, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 572, '2011-01-01 00:00:01', 572, '2012-09-22 04:47:48', 0, '*', 1),
...
(8, 36, 1, 13, 14, 1, 'vj', 'com_content', 'Videojuegos', 'vj', '', '<p>En esta categoria podras encontrar todo tipo de videojuegos<img src="images/Videojuegos.jpg" alt="" /></p>\r\n<p> </p>\r\n<p><span style="color: #515756; font-family: ''Courier News'', monospace; line-height: 18px; background-color: #ffffcc;">{mosmap width=''700''|height=''400''|lat=''41.409905''|lon=''2.18276''|zoom=''12''|mapType=''Hybrid''| text=''Barcelona''|tooltip=''Ciudda Condal''|marker=''1''|align=''center''}</span></p>', -2, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 701, '2013-06-23 02:22:56', 701, '2013-06-24 03:56:32', 0, '*', 1),
(9, 37, 1, 15, 16, 1, 'accesorios', 'com_content', 'Accesorios', 'accesorios', '', '<p>En esta seccion podras encontrar todos los accesorios para tus consolas</p>', -2, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 701, '2013-06-23 02:24:46', 0, '0000-00-00 00:00:00', 0, '*', 1),
(10, 38, 1, 17, 18, 1, 'guias', 'com_content', 'Guias', 'guias', '', '<p>En esta sección encontraras todas las guías digitales de tus videojuegos favoritos </p>', -2, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 701, '2013-06-23 02:25:24', 0, '0000-00-00 00:00:00', 0, '*', 1),
(11, 40, 1, 19, 20, 1, 'conoce', 'com_content', 'Conoce la empresa', 'conoce', '', '<p>Aqui podras ver todo lo necesario para que nuestra tienda genere la confianza necesaria para que hagas compras aqui :)</p>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 701, '2013-06-24 17:49:01', 701, '2013-06-24 17:52:33', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_contact_details`
--

CREATE TABLE IF NOT EXISTS `v2o6t_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `v2o6t_content`
--

CREATE TABLE IF NOT EXISTS `v2o6t_content` (
...
--
-- Volcado de datos para la tabla `v2o6t_content`
--

INSERT INTO `v2o6t_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 39, 'Hola', 'hola', '<p> </p>\r\n<p><span style="font-family: tahoma, arial, helvetica, sans-serif; font-size: 13.333333969116211px; line-height: normal; background-color: #fcfcfc;">{mosmap width=''500''|height=''400''|lat=''32.43021,-116.487073''|lon=''4.447141''| zoom=''3''|zoomType=''Large''|zoomNew=''0''|mapType=''Sat ellite''|showMaptype=''1''| overview=''0''|</span></p>', '', -2, 8, '2013-06-24 04:49:12', 701, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-06-24 04:49:12', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 41, 'Mision Vision Valores', 'mision-vision-valores', '<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;"> Misión:</span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">Satisfacer las necesidades de las personas interesadas en los videojuegos y articulos de novedad, prestandoles el mejor servicio por parte de todo el personal de la empresa, y manteniendo siempre actualizado nuestro catálogo de juegos y articulos para las diferentes plataformas.</span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;"> </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">Visión: </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">Llegar a más lugares de la república mexicana e incluso a diferentes partes del mundo, con el mejor servicio a clientes, con los juegos y artículos más nuevos y actualizados y principalmente con la mejor comodidad y seguridad del mundo.</span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;"> </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">Valores:</span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">RESPETO: Buscamos constantemente mantener la armonía en la relación con compañeros de trabajo, clientes y proveedores. </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">LEALTAD: Tenemos un fuerte compromiso y mostramos fidelidad. Hacemos con respeto nuestras responsabilidades y manifestamos confidencialidad en los aconteceres de la Organización. </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">HONESTIDAD: Siendo íntegros para recibir a cambio la confianza de clientes internos y externos. </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">RESPONSABILIDAD: Cumplimos de manera oportuna y precisa con las actividades propias de cada puesto para escalar y llegar a las metas fijadas. </span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">COMPROMISO: Nos dedicamos a llegar al objetivo establecido y cumplimos responsablemente con las actividades propias del puesto. </span></p>\r\n<p> </p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;">INNOVADOR: Promovemos el cambio permanente en nuestros procesos, productos y servicios como el medio más importante para estar cumpliendo las expectativas de nuestros clientes.</span></p>', '', 1, 11, '2013-06-24 17:49:43', 701, '', '2013-06-26 17:21:55', 701, 0, '0000-00-00 00:00:00', '2013-06-24 17:49:43', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 2, '', '', 1, 6, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 42, '¿Quienes somos?', 'quienes-somos', '<p>Somos una empresa dedicada a la venta de productos Gamers donde podrás encontrar desde consolas, videojuegos, accesorios , juguetes y guías</p>\r\n<p>podras encontrarnos en:</p>\r\n<p>And. Guerra del Salitre  #911</p>\r\n<p>Col. Villa de san Sebastian C.P. 28045</p>\r\n<p> </p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;"><span style="color: #444444; font-family: sans-serif; font-size: 14px; line-height: 20px; background-color: #ffffff;"><span style="font-size: 14px;">{mosmap width=''500''|height=''400''|lat=''</span><span style="font-size: 14px;"><span style="color: #333333; font-family: Tahoma, Helvetica, Arial, sans-serif; font-size: 11.818181991577148px; line-height: 15.795454025268555px;">19.245884</span>''|lon=''</span></span></span><span style="line-height: 1.3em;">-103.707805</span><span style="font-size: 14px; color: #444444; font-family: sans-serif; line-height: 20px;">''|zoom=''3''|zoomType=''Large''|zoomNew=''0''|mapType=''Hybrid''|</span></p>\r\n<p class="MsoNormal"><span style="font-size: 10pt; line-height: 115%; font-family: Tahoma, sans-serif; background-color: #fcfcfc; background-position: initial initial; background-repeat: initial initial;"><span style="color: #444444; font-family: sans-serif; font-size: 14px; line-height: 20px; background-color: #ffffff;"><span style="font-size: 14px;">showMaptype=''1''|overview=''0''|text=''TeChop''|lang=''''}</span></span></span></p>', '', 1, 11, '2013-06-24 17:55:39', 701, '', '2013-06-25 17:49:29', 701, 0, '0000-00-00 00:00:00', '2013-06-24 17:55:39', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 7, 1, '', '', 1, 11, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 43, 'Condiciones de compras', 'condiciones-de-compras', '<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Objeto.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Las presentes Condiciones regulan la relación jurídica derivada de los procesos de contratación formalizados por los Clientes a través del Sitio Web TeChop.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Estas condiciones generales de venta regirá las adquisiciones de cualquier producto (videuegos, consolas, periféricos, etc) (los “Productos”) indicados en nuestro sitio web “<a href="http://www.game.es/" target="_blank" title="GAME" style="margin: 0px; padding: 0px; color: #a70084;">www.TeChop.</a>com” (el “Sitio Web”).</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Los Productos son ofrecidos a la venta exclusivamente para usuarios directos que, en virtud del Real Decreto Legislativo 1/2007, de 16 de noviembre, por el que se aprueba el texto refundido de la Ley General para la Defensa de los Consumidores y Usuarios y otras leyes complementarias (el “TRLGDCU”), tengan la consideración de consumidores (los “Clientes”). En consecuencia, algunas categorías de posibles compradores no podrán adquirir los Productos, tales como aquellos cuyo propósito sea el de revender los Productos a terceros, por ejemplo minoristas/comerciantes, mayoristas, revendedores, profesionales, etc.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Cada operación de compra se rige por lo previsto en el TRLGDCU, en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico y en las demás normativa que resulte de aplicación, así como por las presentes condiciones de venta, publicadas en el link Condiciones de venta del Sitio Web. A menos que se indique lo contrario, el Cliente podrá realizar la operación de compra en el mismo idioma en que están escritas las presentes condiciones de venta. Estas condiciones de venta han sido redactadas por Game Stores Iberia, S.L.U. (en adelante, “GAME”), que es la única contraparte contractual de los Clientes y que asume la obligación de satisfacer los pedidos de Productos. GAME es una sociedad constituida con arreglo a las leyes españolas, tiene número de identificación fiscal (NIF) B81209751, está inscrita en el Registro Mercantil de Madrid, tomo 9627, libro 0, folio 1, sección 8, hoja M-154792, número de inscripción 1, y tiene su domicilio social en la siguiente dirección:</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Game Stores Iberia, S.L.U. C/ Virgilio Nº7-9 28223 Pozuelo de Alarcon Madrid Dirección de correo electrónico: <a href="mailto:pedidos@game.es" target="_blank" title="mailto:pedidos@game.es" style="margin: 0px; padding: 0px; color: #a70084;">pedidos@techop.</a>com</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Duración de las condiciones de compra.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El periodo de vigencia de la oferta y el precio de los Productos se corresponderá con el tiempo durante el cual permanezcan publicados en el Sitio Web de modo que TeChop se reserva el derecho a modificar estas condiciones de venta en el futuro. En tal caso, las condiciones de venta modificadas serán válidas y exigibles sólo con respecto a los pedidos que el Cliente remita con posterioridad a que dichas condiciones revisadas sean publicadas en el Sitio Web. Por consiguiente, TeChop invita al Cliente a revisar la versión más reciente de las condiciones de venta antes de efectuar un pedido así como a imprimirse una copia de las mismas o a almacenarla electrónicamente.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Aceptación de las condiciones generales de venta.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente, con el envío de su pedido, acepta incondicionalmente y se compromete a respetar estas condiciones de venta en sus relaciones con TeChop , manifestando, asimismo, tener la condición de “consumidor” en el sentido del TRLGDCU. El Cliente reconoce que TeChop no está vinculada por condiciones de venta distintas de las aquí establecidas, salvo que se pacte lo contrario con carácter previo y por escrito.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Compromisos del Cliente.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Los Clientes aceptan expresamente la adhesión plena y sin reservas a las presentes estipulaciones, en la versión publicada por TeChop en el momento en que el Cliente contrate el producto y/o contenidos en el que está interesado. Por tanto el Cliente se compromete a leer atentamente las condiciones de contratación, cada vez que proceda a la contratación de algún producto, dado que las mismas han podido ser objeto de modificación desde la última vez que accedió.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Mediante la aceptación de las presentes Condiciones Generales de contratación el Cliente declara:</p>\r\n<p> </p>\r\n<ul style="margin: 0px; padding: 0px; list-style-position: outside; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">- Que es una persona con capacidad para contratar.</li>\r\n<li style="margin: 0px; padding: 0px;">- Que ha leído y acepta las presentes condiciones generales de contratación.</li>\r\n</ul>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente tendrá acceso siempre y en todo caso, con carácter previo al inicio del procedimiento de contratación de productos, a las condiciones de contratación, pudiendo ser almacenadas y/o reproducidas en un soporte duradero.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente reconoce que el contrato de compraventa de Productos se perfecciona cuando se completa el procedimiento de compra; asimismo el Cliente reconoce que es en ese momento cuando el Cliente deviene obligado a pagar el precio final de compra de los Productos adquiridos, que incluirá todos los impuestos aplicables y desglosará los gastos adicionales incurridos durante el proceso de compra.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Los precios y tarifas aplicables a la contratación por parte del Cliente de los servicios serán los que figuren en el Sitio Web en el momento en el que el Cliente acceda al servicio específico y proceda a iniciar el proceso de contratación.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop se reserva el derecho a modificar los precios de los productos publicados en el Sitio Web mencionado anteriormente cuando así lo considere conveniente y haciéndolo visible en el Sitio Web. Todos los materiales incluidos en el Sitio Web (incluyendo a título enunciativo y no limitativo todas las imágenes, textos, marcas, logotipos u otros signos distintivos) pertenecen a TeChop o a terceros licenciantes y están protegidos como obras sujetas a derechos de propiedad intelectual o industrial.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">En consecuencia, el Cliente no podrá reproducir, transformar, modificar, desensamblar, realizar ingeniería inversa, distribuir, alquilar, prestar, poner a disposición, o permitir el acceso al público a través de cualquier modalidad de comunicación pública de ninguno de los elementos referidos en el párrafo anterior, sin la previa autorización por escrito de TeChop o del tercero titular legítimo de los derechos correspondientes. El Cliente deberá utilizar los Productos únicamente para sus propias necesidades, obligándose a no realizar ni directa ni indirectamente una explotación comercial de los materiales, elementos e información contenidos en los mismos La infracción de esta cláusula puede conllevar el inicio de acciones legales, tanto civiles como penales, contra el infractor.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Trámites para celebrar el contrato de compraventa.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente deberá darse de alta como usuario en la página web, debe disponer de una dirección de correo electrónico y proporcionar datos veraces y exactos; siendo el cliente el responsable de toda la actividad de su cuenta. Su cuenta puede ser cancelada si se emplea para llevar a cabo actividades que infrinjan las presentes condiciones de contratación.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El contrato se formaliza en lengua española, de acuerdo con las presentes Condiciones.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Las ofertas tendrán la vigencia que se especifique en cada caso en el Sitio Web.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente podrá consultar las características esenciales de cada producto a través de su descripción en el Sitio Web.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Para comprar en el Sitio Web se le pedirá que siga los siguientes pasos:</p>\r\n<p> </p>\r\n<ol style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">1- Seleccione el Producto deseado. El precio final en función de los servicios adicionales seleccionados se le mostrará automáticamente. Dicho precio final incluirá tanto los gastos de transporte como otros posibles gastos indicados durante el procedimiento de compra.</li>\r\n<li style="margin: 0px; padding: 0px;">2- Iniciar Sesión o Registro nuevo usuario.-Introduce tus datos de usuario o crea tu cuenta si es la primera vez que se realiza un pedido en la web.</li>\r\n<li style="margin: 0px; padding: 0px;">3- Confirmación datos de envío.</li>\r\n<li style="margin: 0px; padding: 0px;">4- Selección medio de pago.- Tarjeta de crédito o contrareembolso.</li>\r\n<li style="margin: 0px; padding: 0px;">5- Confirmación de la compra.</li>\r\n</ol>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Derechos y obligaciones de las partes.</h3>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">a. Obligaciones de <span style="font-weight: normal;">TeChop</span>:</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop, se compromete a cumplir con las siguientes obligaciones contractuales derivadas de la relación comercial con el Cliente consecuencia de la contratación los servicios por parte del mismo:</p>\r\n<p> </p>\r\n<ul style="margin: 0px; padding: 0px; list-style-position: outside; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">- Prestar con las máximas garantías al Cliente, el servicio solicitado por éste conforme a lo dispuesto en las condiciones de contratación, sin faltar a la buena fe contractual.</li>\r\n<li style="margin: 0px; padding: 0px;">- Informar expresamente al Cliente de la existencia de las presentes condiciones. con carácter previo al inicio del procedimiento de contratación.</li>\r\n<li style="margin: 0px; padding: 0px;">- Informar al Cliente con carácter previo a la contratación y de manera concreta, clara, precisa e inequívoca, de las características específicas de los servicios solicitados, tales como el precio de los mismos y los impuestos que le sean de aplicación.</li>\r\n</ul>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">b. Obligaciones del Cliente:</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Por su parte, el Cliente se compromete a:</p>\r\n<p> </p>\r\n<ul style="margin: 0px; padding: 0px; list-style-position: outside; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">- Llevar a cabo el íntegro cumplimiento de lo establecido en las presentes condiciones de los servicios facilitados por TeChop.</li>\r\n<li style="margin: 0px; padding: 0px;">- Completar los formularios de registro previos al inicio del procedimiento de contratación con información veraz y actual.</li>\r\n<li style="margin: 0px; padding: 0px;">- Facilitar, de forma correcta los datos bancarios solicitados por TeChop.</li>\r\n<li style="margin: 0px; padding: 0px;">- Pagar el precio de los productos adquiridos, sin que la presentación de una reclamación le exima de esta obligación.</li>\r\n</ul>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">c. Derechos del Cliente:</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Toda la información proporcionada al cliente tendrá el carácter de vinculante para el oferente en los términos establecidos por la legislación vigente. Todo Cliente tiene derecho a que los bienes que adquiera sean de la categoría y requerimientos legales contratados o de aquella calidad que guarde proporción directa con la categoría del establecimiento.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Entrega de los Productos.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop entregará los Productos adquiridos en la dirección indicada por el Cliente aunque únicamente cuando se trate de una dirección situada dentro del territorio español a excepción de Canarias, Ceuta y Melilla. TeChop  arantiza el envío en 24-48 horas hábiles, en función de la zona geográfica, de todos los productos que tengan en stock y siempre que los pedidos sean confirmados en nuestra web de Lunes a Viernes antes de las 14:30 horas. Los pedidos recibidos en sábados, domingos y festivos se considerarán recibidos el primer día laborable posterior al mismo.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Productos fuera de stock.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Si los Productos no están en stock, esa circunstancia se mostrará en el Sitio Web y el Cliente no podrá realizar su pedido hasta que los Productos estén en stock y disponibles para el envío. Si TeChop detecta, una vez recibido el pedido del Cliente, que un Producto está fuera de stock, TeChop lo notificará al Cliente y, entonces, el Cliente podrá (i) cancelar el pedido completo o (ii) cancelar el pedido relativo al Producto que está fuera de stock pero aceptando la entrega de los Productos solicitados que sí están en stock.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El horario de entrega y los costes correspondientes dependerán de la disponibilidad del Producto, de las modalidades de envío y del mensajero en cuestión.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El riesgo de pérdida o daños en la mercancía se transmite al cliente desde el momento en que se produce la entrega en el domicilio del cliente.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop se hace responsable bajo ningún concepto de los daños ocasionados por el mal uso de las mercancías.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Garantías y Productos defectuosos.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Todos los productos comercializados por GAME cumplen con el Texto Refundido de la Ley General para la Defensa de los consumidores y usuarios RDL 1/2007, del 16 de noviembre; para todas las cuestiones no previstas en dicha normativa, a las disposiciones específicas del Código Civil español que sean aplicables a estas cuestiones.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Esta garantía tendrá un plazo de dos años para los productos nuevos y de un año para los productos de segunda mano (Seminuevos) desde la fecha de entrega de los Productos. Si el fallo en el producto se manifiesta durante los seis primeros meses desde la entrega del mismo, se presume que dicho fallo existía cuando se entregó. A partir del sexto mes, el cliente deberá demostrar que el fallo del producto existía en el momento de la venta.</p>\r\n<p> </p>\r\n<ul style="margin: 0px; padding: 0px; list-style-position: outside; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">- Para productos defectuosos nuevos el consumidor puede optar a su elección entre la reparación del producto o la sustitución del mismo por uno igual.</li>\r\n<li style="margin: 0px; padding: 0px;">- Para productos defectuosos seminuevos el consumidor solo tendrá derecho a la sustitución por un producto igual.</li>\r\n</ul>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">En ambos casos los artículos defectuosos deben presentar buena conservación y únicamente se sustituirá el producto defectuoso y no todo el conjunto (embalaje, manual de instrucciones, etc...). Siempre debe presentarse el ticket.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">La mencionada garantía no será aplicable en el caso de que concurra negligencia, uso negligente o mantenimiento negligente del Producto, o en relación con la conexión del Producto a sistemas eléctricos u otros tipos de sistemas que no sean conformes con las leyes y reglamentos aplicables.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Cliente deberá informar de cualquier error de funcionamiento de los Productos, debiendo enviar un correo electrónico a la siguiente dirección de email garantias@TeChop.com El correo electrónico debe recoger la factura de compra, la marca y el modelo del Producto defectuoso y una descripción del defecto descubierto. Una vez enviado el correo electrónico, el Cliente recibirá por correo electrónico una respuesta escrita y un resumen con la información necesaria para ejecutar la garantía. Esta es la única vía para obtener la sustitución, la reparación o el reembolso de los Productos defectuosos.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Producto defectuoso será devuelto a TeChop en un paquete cerrado, sin coste para el cliente, enviado a la dirección indicada en la primera cláusula de estas condiciones de venta. TeChop se reserva el derecho a verificar la realidad del defecto alegado por el Cliente o que los Productos no presenten signos de sabotaje, uso incorrecto o daños causados por el Cliente. Sólo después de dicha verificación TeChop procederá a sustituir, reparar o rembolsar el Producto, según proceda.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Las reparaciones y sustituciones se llevarán a cabo dentro de un periodo de tiempo razonable tras la solicitud, teniendo en cuenta la disponibilidad de Productos sustitutos, así como los gastos y plazos necesarios para efectuar las reparaciones. Los gastos de envío, de mano de obra y de materiales correrán a cargo de TeChop.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Cuando la reparación y la sustitución resulten imposibles o excesivamente onerosas, el Cliente tendrá derecho a la terminación del contrato (terminación que conllevará la devolución del Producto y el total reembolso de las cantidades ya pagadas).</p>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Derecho de desistimiento.</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Todas las compras efectuadas en el Sitio Web se rigen por las disposiciones del TRLGDCU relativas a la contratación a distancia. En particular, el Cliente tiene derecho a desistir del contrato de compra de Productos, sin incurrir en ninguna penalización o cargo y sin obligación alguna de comunicar las razones de dicho desistimiento, dentro de los 7 (siete) días naturales siguientes a la fecha de entrega del Producto.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El derecho de desistimiento se puede ejercitar enviando, dentro del plazo arriba indicado, una comunicación por escrito a la siguiente dirección de mail: pedidos@TeChop.com</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El correo electrónico debe incluir la factura de compra, la marca y el modelo del Producto a devolver y, a discreción del Cliente, una breve descripción de las razones del desistimiento. Una vez enviado el correo electrónico, el Cliente recibirá por correo electrónico una respuesta de TeChop</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">El Producto a devolver deberá ser enviado a TeChop en un paquete cerrado y dirigido a la dirección indicada en la primera cláusula de las presentes condiciones de venta.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop aceptará sin demora la devolución de cualquier Producto, siempre que esté en perfectas condiciones, y completo (embalajes, manual de instrucciones) y que el derecho de desistimiento se haya ejercitado de conformidad con los términos y condiciones mencionados anteriormente, y reembolsará todas las cantidades pagadas (excepto los costes directos de la devolución, conforme a lo dispuesto por la legislación española). En el caso de videojuegos (nuevos), para poder ejercitar el derecho de desistimiento será necesario devolver el Producto dentro de su embalaje original todavía precintado.</p>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">No obstante, el citado derecho a desistir del contrato no será aplicable en el caso de venta de productos cuyo soporte sean ficheros informáticos, suministrados por vía electrónica, susceptibles de ser descargados o reproducidos con carácter inmediato para su uso permanente.</p>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Error en el envío:</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">En el caso de un envío erróneo, TeChop se hará cargo de la recogida del producto (servicio exclusivo península y baleares) y procederá al envío correcto sin coste para el cliente una vez que el producto erróneo haya sido entregado a nuestra Central; siempre y cuando se comunique la incidencia dentro de los 7 primeros días a la fecha de compra, mediante el envío de un mail a pedidos@TeChop.com</p>\r\n<p><br style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;" /><strong style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Producto rehusado:</strong></p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Si por causas no achacables a TeChop o a la agencia de transporte el pedido fuese rehusado por el cliente, TeChop se reserva el derecho de reclamar al cliente los gastos de envío correspondientes al envío estándar. El abono de dichos portes se realizará o bien con cargo a la tarjeta de crédito con la que se realizó la compra, o bien por cualquier otro medio acordado posteriormente con el cliente.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Cancelación de pedidos por <span style="color: #7a7a7a; font-size: 11px; font-weight: normal; line-height: 16px;">TeChop</span>.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop se reserva el derecho a cancelar pedidos o determinados Productos de un pedido si concurre alguna de las siguientes circunstancias:</p>\r\n<p> </p>\r\n<ul style="margin: 0px; padding: 0px; list-style-position: outside; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">\r\n<li style="margin: 0px; padding: 0px;">- Productos calificados como no disponibles o fuera de catálogo por los distribuidores;</li>\r\n<li style="margin: 0px; padding: 0px;">- Productos que no puedan ser entregados por los proveedores debido a problemas;</li>\r\n<li style="margin: 0px; padding: 0px;">- Fraude relativo a la tarjeta de crédito;</li>\r\n<li style="margin: 0px; padding: 0px;">- Uso incorrecto de cupones de descuento;</li>\r\n<li style="margin: 0px; padding: 0px;">- Fraude contra TeChop.</li>\r\n</ul>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop informará al Cliente sobre la cancelación de cualquier pedido y le reembolsará todas las cantidades pagadas por dicho pedido dentro de los 30 días naturales siguientes.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Privacidad.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">TeChop adopta medidas de seguridad en el tratamiento de datos que ofrecen el máximo nivel de confidencialidad para sus Clientes, cumpliendo plenamente con la normativa española sobre protección de datos de carácter personal. El aviso legal relativo al tratamiento de datos de carácter personal está disponible en el link <a href="http://www.game.es/Help/Sections.aspx?Section=_HELP_LEGAL" target="_blank" style="margin: 0px; padding: 0px; color: #a70084;">http://www.game.es/Help/Sections.aspx?Section=_HELP_LEGAL</a> , a la que nos remitimos para todas las cuestiones relacionadas con la protección de datos de carácter personal. Formulando un pedido a través del Sitio Web, el Cliente acepta de forma expresa que sus datos de carácter personal sean tratados tal y como se describe en el aviso de privacidad.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Servicio postventa, información y quejas.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Para cualquier aclaración, reclamación, queja o información relativa al servicio postventa, el Cliente puede ponerse en contacto con TeChop en nuestro número de teléfono 902171819 de lunes a viernes de 9:00 a 18:00 horas o en el correo electrónico pedidos@game.es o bien enviando una comunicación por escrito a la dirección de TeChop indicada en la cláusula primera de las presentes condiciones de venta, a la atención de los Servicios de Atención al Cliente.</p>\r\n<p> </p>\r\n<h3 style="margin: 0px; padding: 0px; color: #a70084; line-height: 20px; font-family: Verdana, Geneva, sans-serif;">Ley y jurisdicción aplicables.</h3>\r\n<p> </p>\r\n<p style="margin: 0px; padding: 0px; color: #7a7a7a; font-family: Verdana, Geneva, sans-serif; font-size: 11px; line-height: 16px;">Las presentes condiciones de venta y todos los pedidos se regirán por las leyes españolas. Los tribunales del lugar de residencia o domicilio del Cliente gozarán de jurisdicción exclusiva sobre cualquier controversia que pueda surgir en relación con la validez, la interpretación o la aplicación de las presentes condiciones de venta y de cualquier pedido.</p>', '', 1, 11, '2013-06-25 17:30:29', 701, '', '2013-06-25 17:36:47', 701, 0, '0000-00-00 00:00:00', '2013-06-25 17:30:29', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, '', '', 1, 2, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `v2o6t_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `v2o6t_content_rating`
--

CREATE TABLE IF NOT EXISTS `v2o6t_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `v2o6t_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `v2o6t_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `v2o6t_extensions`
--

CREATE TABLE IF NOT EXISTS `v2o6t_extensions` (
...
--
-- Volcado de datos para la tabla `v2o6t_extensions`
--

INSERT INTO `v2o6t_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(20, 'com_templates', 'component', 'com_templates', '', 1, 1, 1, 1, '{"name":"com_templates","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_TEMPLATES_XML_DESCRIPTION","group":""}', '{"template_positions_display":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'hikashop', 'component', 'com_hikashop', '', 1, 1, 0, 0, '{"name":"HikaShop","type":"component","creationDate":"June 2012","author":"hikashop.com","copyright":"(C) 2010-2013 HIKARI SOFTWARE. All rights reserved.","authorEmail":"dev@hikashop.com","authorUrl":"http:\\/\\/www.hikashop.com","version":"2.1.3","description":"E-Commerce software built for simplicity and flexibility","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Hikashop Social Networks Plugin', 'plugin', 'hikashopsocial', 'content', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'Hikashop product tag insertion plugin', 'plugin', 'hikashopproduct', 'editors-xtd', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'HikaShop order history plugin', 'plugin', 'history', 'hikashop', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10004, 'HikaShop Shipping manual - Prices per product plugin', 'plugin', 'shippingmanual_prices', 'hikashop', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10005, 'HikaShop joomla user account link plugin', 'plugin', 'user_account', 'hikashop', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10006, 'HikaShop Free orders validation Plugin', 'plugin', 'validate_free_order', 'hikashop', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10007, 'HikaShop Payza payment plugin', 'plugin', 'alertpay', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10008, 'HikaShop AliPay payment plugin', 'plugin', 'alipay', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10009, 'HikaShop Amazon payment plugin', 'plugin', 'amazon', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10010, 'HikaShop SIPS Atos payment plugin', 'plugin', 'atos', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10011, 'HikaShop Authorize.net payment plugin', 'plugin', 'authorize', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10012, 'HikaShop bank transfer payment plugin', 'plugin', 'banktransfer', 'hikashoppayment', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10013, 'HikaShop WorldPay Business Gateway payment plugin', 'plugin', 'bf_rbsbusinessgateway', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10014, 'HikaShop WorldPay Global Gateway payment plugin', 'plugin', 'bf_rbsglobalgateway', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10015, 'HikaShop Bluepaid payment plugin', 'plugin', 'bluepaid', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10016, 'HikaShop CardSave payment plugin', 'plugin', 'cardsave', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10017, 'HikaShop CECA payment plugin', 'plugin', 'ceca', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10018, 'HikaShop check payment plugin', 'plugin', 'check', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10019, 'HikaShop CM-CIC payment plugin', 'plugin', 'cmcic', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10020, 'HikaShop collect on delivery payment plugin', 'plugin', 'collectondelivery', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10021, 'HikaShop credit card payment plugin', 'plugin', 'creditcard', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10022, 'HikaShop ePay payment plugin', 'plugin', 'epay', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10023, 'HikaShop eSelect/Moneris payment plugin', 'plugin', 'eselect', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10024, 'HikaShop eWAY payment plugin', 'plugin', 'eway', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10025, 'HikaShop First Data payment plugin', 'plugin', 'firstdata', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10026, 'HikaShop Google Checkout payment plugin', 'plugin', 'googlecheckout', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10027, 'HikaShop HSBC payment plugin', 'plugin', 'hsbc', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10028, 'HikaShop Innovative Gateway payment plugin', 'plugin', 'innovativegateway', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10029, 'HikaShop iPayDNA payment plugin', 'plugin', 'ipaydna', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10030, 'HikaShop iVeri payment plugin', 'plugin', 'iveri', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10031, 'HikaShop MIGS VPC payment plugin', 'plugin', 'migsvpc', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10032, 'HikaShop Moneybookers payment plugin', 'plugin', 'moneybookers', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10033, 'HikaShop Ogone payment plugin', 'plugin', 'ogone', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10034, 'HikaShop OKPay payment plugin', 'plugin', 'okpay', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10035, 'HikaShop PayJunction payment plugin', 'plugin', 'payjunction', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10036, 'HikaShop Payment Express payment plugin', 'plugin', 'paymentexpress', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10037, 'HikaShop Paypal payment plugin', 'plugin', 'paypal', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10038, 'HikaShop PayPal Pro payment plugin', 'plugin', 'paypalpro', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10039, 'HikaShop Post Finance payment plugin', 'plugin', 'postfinance', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10040, 'HikaShop Sage Pay payment plugin', 'plugin', 'sagepay', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10041, 'HikaShop Servired payment plugin', 'plugin', 'servired', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10042, 'HikaShop VirtualMerchant payment plugin', 'plugin', 'virtualmerchant', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10043, 'HikaShop Western Union payment plugin', 'plugin', 'westernunion', 'hikashoppayment', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10044, 'HikaShop Australia Post shipping plugin', 'plugin', 'aupost', 'hikashopshipping', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10045, 'HikaShop Canada Post shipping plugin', 'plugin', 'canadapost', 'hikashopshipping', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10046, 'HikaShop Fedex shipping plugin', 'plugin', 'fedex', 'hikashopshipping', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10047, 'HikaShop manual shipping plugin', 'plugin', 'manual', 'hikashopshipping', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10048, 'HikaShop UPS shipping plugin', 'plugin', 'ups', 'hikashopshipping', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10049, 'HikaShop categories search plugin', 'plugin', 'hikashop_categories', 'search', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10050, 'HikaShop products search plugin', 'plugin', 'hikashop_products', 'search', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10051, 'HikaShop tax calculations override plugin', 'plugin', 'custom_quantity_tax', 'system', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10052, 'HikaShop product tag translation plugin', 'plugin', 'hikashopproductinsert', 'system', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10053, 'HikaShop Microdata on Product Page plugin', 'plugin', 'hikashopproducttag', 'system', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10054, 'Redirect Joomla registration to HikaShop Plugin', 'plugin', 'hikashopregistrationredirect', 'system', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10055, 'HikaShop user synchronization plugin', 'plugin', 'hikashopuser', 'system', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10056, 'HikaShop no SSL outside checkout plugin', 'plugin', 'nossloutsidecheckout', 'system', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10057, 'VirtueMart Fallback Redirect Plugin', 'plugin', 'vm_redirect', 'system', 0, 0, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10058, 'HikaShop Content Module', 'module', 'mod_hikashop', '', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10059, 'HikaShop Cart Module', 'module', 'mod_hikashop_cart', '', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10060, 'HikaShop Currency Switcher Module', 'module', 'mod_hikashop_currency', '', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10061, 'System - Google Maps', 'plugin', 'plugin_googlemap3', 'system', 0, 1, 1, 0, '{"name":"System - Google Maps","type":"plugin","creationDate":"January 2013","author":"Mike Reumer","copyright":"(C) 2013 Reumer","authorEmail":"tech@reumer.net","authorUrl":"tech.reumer.net","version":"3.0","description":"PLUGIN_GOOGLE_MAP3_INSTALLATION","group":""}', '{"publ":"","debug":"0","plugincode":"mosmap","brackets":"{","Google_API_version":"3.x","visualrefresh":"0","show":"1","mapclass":"","mapcss":"\\/* For img in the map remove borders, shadow, no margin and no max-width\\r*\\/\\r.map img, .svPanel img {\\r    border: 0px;\\r    box-shadow: 0px;\\r    margin: 0px !important;\\r    padding: 0px !important;\\r    max-width: none !important;\\r    background: none !important;\\r}\\r\\r\\/* Make sure the directions are below the map\\r*\\/\\r.directions {\\r    clear: left;\\r}\\r\\r.adp-directions {\\r    width: 100%;\\r}\\r\\r\\/* Solve problems in chrome with the show of the direction steps in full width\\r*\\/\\r.adp-placemark {\\r    width : 100%;\\r}\\r\\r\\/* Padding for image overlay\\r*\\/\\r.controlDiv {\\r    padding : 5px;\\r}\\r","loadmootools":"1","timeinterval":"500","Google_API_key":"","Google_Multi_API_key":"","urlsetting":"http_host","googlewebsite":"maps.google.com","styledmap":"","align":"center","langtype":"site","lang":"","width":"500","height":"400","effect":"none","lat":"52.075581","lon":"4.541513","centerlat":"","centerlon":"","address":"","latitudeid":"","latitudedesc":"1","latitudecoord":"0","latitudeform":"0","controltype":"UI","zoomType":"3D-large","svcontrol":"1","returncontrol":"1","zoom":"10","corzoom":"0","minzoom":"0","maxzoom":"19","rotation":"1","zoomnew":"0","zoomWheel":"0","keyboard":"0","mapType":"Normal","showmaptype":"1","showNormalMaptype":"1","showSatelliteMaptype":"1","showHybridMaptype":"1","showTerrainMaptype":"1","showEarthMaptype":"1","showscale":"0","overview":"0","dragging":"1","marker":"1","icon":"","iconwidth":"","iconheight":"","iconanchorx":"","iconanchory":"","iconshadow":"","iconshadowwidth":"","iconshadowheight":"","iconimagemap":"","traffic":"0","transit":"0","bicycle":"0","panoramio":"0","pano_userid":"","pano_tag":"","weather":"0","weathercloud":"0","weatherinfo":"1","weathertempunit":"celsius","weatherwindunit":"km","dir":"0","dirtype":"D","formdirtype":"1","avoidhighways":"0","avoidtoll":"0","diroptimize":"0","diralternatives":"0","showdir":"1","animdir":"0","animspeed":"1","animautostart":"0","animunit":"kilometers","formspeed":"0","formaddress":"0","formdir":"0","autocompl":"both","langanim":"en;The requested panorama could not be displayed|Could not generate a route for the current start and end addresses|Street View coverage is not available for this route|You have reached your destination|miles|miles|ft|kilometers|kilometer|meters|In|You will reach your destination|Stop|Drive|Press Drive to follow your route|Route|Speed|Fast|Medium|Slow","txtdir":"Directions: ","txtgetdir":"Get Directions","txtfrom":"From here","txtto":"To here","txtdiraddr":"Address: ","txt_driving":"","txt_avhighways":"","txt_avtoll":"","txt_walking":"","txt_bicycle":"","txt_transit":"","txt_optimize":"","txt_alternatives":"","inputsize":"25","dirdefault":"0","gotoaddr":"0","gotoaddrzoom":"0","txtaddr":"Address: ##","erraddr":"Address ## not found!","clientgeotype":"google","lightbox":"0","txtlightbox":"Open lightbox","lbxcaption":"","lbxwidth":"500","lbxheight":"700","lbxcenterlat":"","lbxcenterlon":"","lbxzoom":"","sv":"none","svwidth":"100%","svheight":"300","svyaw":"0","svpitch":"0","svzoom":"","svautorotate":"0","svaddress":"1","earthtimeout":"300","earthborders":"1","earthbuildings":"0","earthroads":"0","earthterrain":"0","kmlrenderer":"google","kmlsidebar":"none","kmlsbwidth":"200","kmlfoldersopen":"0","kmlhide":"0","kmlscale":"0","kmlopenmethod":"click","kmlsbsort":"none","kmllightbox":"0","kmlmessshow":"0","kmlclickablemarkers":"1","kmlzoommarkers":"0","kmlopendivmarkers":"","kmlcontentlinkmarkers":"0","kmllinkablemarkers":"0","kmllinktarget":"_self","kmllinkmethod":"dblclick","kmlhighlite":"{ ''color'': ''#aaffff'', ''opacity'': 0.3,  ''textcolor'': ''#000000'' }","kmlmarkerlabel":"100","kmlmarkerlabelclass":"","kmlpolylabel":"100","kmlpolylabelclass":"","proxy":"1","maxcluster":"","clustericonurl":"\\/media\\/plugin_googlemap3\\/site\\/geoxmlv3\\/images\\/m","gridsize":"","minmarkerscluster":"","maxlinesinfocluster":"","clusterinfowindow":"click","clusterzoom":"dblclick","clustermarkerzoom":"16","tilelayer":"","tilemethod":"","tileopacity":"1","tilebounds":"","tileminzoom":"0","tilemaxzoom":"19","imageurl":"","imageposition":"RIGHT_TOP","imageindex":"1","imagewidth":"","imageheight":"","twittername":"","twittertweets":"15","twittericon":"\\/media\\/plugin_googlemap3\\/site\\/Twitter\\/twitter_map_icon.png","twitterline":"#ff0000ff","twitterlinewidth":"4","twitterstartloc":"0,0,0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_finder_filters`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_filters` (
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links` (
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `v2o6t_finder_taxonomy`
--

INSERT INTO `v2o6t_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_terms`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_terms` (
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `v2o6t_finder_terms_common`
--

INSERT INTO `v2o6t_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `v2o6t_finder_types`
--

CREATE TABLE IF NOT EXISTS `v2o6t_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_address`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_address` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_address`
--

INSERT INTO `v2o6t_hikashop_address` (`address_id`, `address_user_id`, `address_title`, `address_firstname`, `address_middle_name`, `address_lastname`, `address_company`, `address_street`, `address_street2`, `address_post_code`, `address_city`, `address_telephone`, `address_telephone2`, `address_fax`, `address_state`, `address_country`, `address_published`, `address_vat`, `address_default`) VALUES
(1, 1, 'Mr', 'Super', NULL, 'Usuario', NULL, 'And. Guerra del Salitre 911', '', '', 'Colima', '3138607', NULL, NULL, 'state_Colima_2538', 'country_Mexico_138', 1, NULL, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_badge`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_badge` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_banner`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_banner` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_cart`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_cart` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_cart`
--

INSERT INTO `v2o6t_hikashop_cart` (`cart_id`, `user_id`, `session_id`, `cart_modified`, `cart_coupon`, `cart_type`, `cart_current`, `cart_share`, `cart_name`) VALUES
(1, 0, 'fi816vf802gicv37rls5ubveh7', 1372048251, '', 'cart', 0, 'nobody', ''),
(2, 0, 'muj6jpramnllf1u2852s3guaq3', 1372096825, '', 'cart', 0, 'nobody', ''),
(3, 0, 'n6upaab4909ee6ebh7hdb9kpf6', 1372098234, '', 'cart', 0, 'nobody', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_cart_product`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_cart_product` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_cart_product`
--

INSERT INTO `v2o6t_hikashop_cart_product` (`cart_product_id`, `cart_id`, `product_id`, `cart_product_quantity`, `cart_product_parent_id`, `cart_product_modified`, `cart_product_option_parent_id`, `cart_product_wishlist_id`) VALUES
(1, 1, 1, 2, 0, 1372048235, 0, 0),
(2, 1, 2, 1, 0, 1372048251, 0, 0),
(3, 2, 7, 2, 0, 1372095969, 0, 0),
(4, 2, 2, 1, 0, 1372096825, 0, 0),
(7, 3, 6, 1, 0, 1372098228, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_category`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_category` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_category`
--

INSERT INTO `v2o6t_hikashop_category` (`category_id`, `category_parent_id`, `category_type`, `category_name`, `category_description`, `category_published`, `category_ordering`, `category_left`, `category_right`, `category_depth`, `category_namekey`, `category_created`, `category_modified`, `category_access`, `category_menu`, `category_keywords`, `category_meta_description`, `category_layout`, `category_page_title`, `category_alias`, `category_site_id`, `category_canonical`) VALUES
...
(12, 2, 'product', 'Consolas', '<p><img src="images/Videojuegos.jpg" alt="" /></p>', 1, 1, 3, 4, 2, 'product_1371955310_15191', 1371955310, 1371955316, 'all', 0, '', '', '', '', '', '', ''),
(13, 2, 'product', 'Guías ', '<p><img src="images/unsolved_crimes.jpg" alt="" /></p>', 1, 2, 5, 6, 2, 'product_1371955396_30684', 1371955396, 1371955396, 'all', 0, '', '', '', '', '', '', ''),
(14, 2, 'product', 'Videojuegos', '<p><img src="images/Videojuegos-2.jpg" alt="" /></p>', 1, 3, 7, 8, 2, 'product_1371955469_16613', 1371955469, 1371955472, 'all', 0, '', '', '', '', '', '', ''),
(15, 2, 'product', 'Juguetes ', '<p><img src="images/juguetes.jpg" alt="" /></p>', 1, 4, 9, 10, 2, 'product_1371955615_11398', 1371955615, 1371955615, 'all', 0, '', '', '', '', '', '', ''),
(16, 2, 'product', 'Accesorios', '<p><img src="images/accesorios.jpg" alt="" /></p>', 1, 5, 11, 12, 2, 'product_1371955715_30276', 1371955715, 1371955715, 'all', 0, '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_characteristic`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_characteristic` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_click`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_click` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_config`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_config` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_config`
--

INSERT INTO `v2o6t_hikashop_config` (`config_namekey`, `config_value`, `config_default`) VALUES
('level', 'Starter', 'Starter'),
('version', '2.1.3', '2.1.3'),
('from_name', 'TeCho', 'TeCho'),
('from_email', 'josue226@gmail.com', 'josue226@gmail.com'),
('reply_name', 'TeCho', 'TeCho'),
('reply_email', 'josue226@gmail.com', 'josue226@gmail.com'),
('bounce_email', '', ''),
('add_names', '1', '1'),
...
('allowedimages', 'gif,jpg,jpeg,png', 'gif,jpg,jpeg,png'),
('uploadfolder', 'media/com_hikashop/upload/', 'media/com_hikashop/upload/'),
...
('cron_fullreport', '1', '1'),
('cron_savereport', '2', '2'),
('cron_savepath', 'media/com_hikashop/upload/safe/logs/report_959899902.log', 'media/com_hikashop/upload/safe/logs/report_959899902.log'),
('payment_log_file', 'media/com_hikashop/upload/safe/logs/report_287078857.log', 'media/com_hikashop/upload/safe/logs/report_287078857.log'),
...
('max_y_popup', '480', '480'),
('vat_check', '0', '0'),
('default_translation_publish', '0', '0'),
...
('store_address', 'ACME Corporation\nGuildhall\n PO Box 270, London\nUnited Kingdom', 'ACME Corporation\nGuildhall\n PO Box 270, London\nUnited Kingdom'),
...
('default_params', '', ''),
...
('catalogue', '0', '0'),
('redirect_url_after_add_cart', 'stay_if_cart', 'stay_if_cart'),
('redirect_url_when_cart_is_empty', '', ''),
('cart_retaining_period_checked', '1372267363', ''),
...
('Enterprise', '3', '3'),
('Unlimited', '9', '9'),
('params_87', 'YTo1OntzOjEyOiJjb250ZW50X3R5cGUiO3M6NzoicHJvZHVjdCI7czoxMToibGF5b3V0X3R5cGUiO3M6MzoiZGl2IjtzOjY6InJhbmRvbSI7aTowO3M6MTk6ImNvbnRlbnRfc3luY2hyb25pemUiO3M6MToiMSI7czo3OiJjb2x1bW5zIjtpOjM7fQ==', ''),
('menu_102', '', ''),
('params_88', 'YTo1OntzOjEyOiJjb250ZW50X3R5cGUiO3M6NzoicHJvZHVjdCI7czoxMToibGF5b3V0X3R5cGUiO3M6MzoiZGl2IjtzOjY6InJhbmRvbSI7aTowO3M6MTk6ImNvbnRlbnRfc3luY2hyb25pemUiO3M6MToiMSI7czo3OiJjb2x1bW5zIjtpOjM7fQ==', ''),
('menu_103', '', ''),
('params_89', 'YTo1OntzOjEyOiJjb250ZW50X3R5cGUiO3M6NzoicHJvZHVjdCI7czoxMToibGF5b3V0X3R5cGUiO3M6MzoiZGl2IjtzOjY6InJhbmRvbSI7aTowO3M6MTk6ImNvbnRlbnRfc3luY2hyb25pemUiO3M6MToiMSI7czo3OiJjb2x1bW5zIjtpOjM7fQ==', ''),
('menu_106', '', ''),
('params_90', '', ''),
('params_91', '', ''),
('params_92', '', ''),
('params_93', '', ''),
('params_94', '', ''),
('params_95', '', ''),
('params_96', '', ''),
('params_97', '', ''),
('params_98', '', ''),
('product_show_modules', '98', ''),
('website', 'http://localhost/joomla/', ''),
('params_103', '', ''),
('menu_101', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_currency`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_currency` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_currency`
--

INSERT INTO `v2o6t_hikashop_currency` (`currency_id`, `currency_symbol`, `currency_code`, `currency_format`, `currency_name`, `currency_published`, `currency_rate`, `currency_locale`, `currency_displayed`, `currency_percent_fee`, `currency_modified`) VALUES
...
(78, '₪', 'ILS', '%i', 'Israeli new sheqel', 0, 1.00000, '', 0, 0.00, 0),
...
(100, '$', 'MXN', '%i', 'Mexican peso', 1, 1.00000, 'a:13:{s:17:"mon_decimal_point";s:1:",";s:17:"mon_thousands_sep";s:1:" ";s:12:"mon_grouping";s:1:"3";s:13:"positive_sign";s:0:"";s:13:"negative_sign";s:1:"-";s:15:"int_frac_digits";i:2;s:11:"frac_digits";i:2;s:13:"p_cs_precedes";i:0;s:14:"p_sep_by_space";i:1;s:13:"n_cs_precedes";i:0;s:14:"n_sep_by_space";i:1;s:11:"p_sign_posn";i:1;s:11:"n_sign_posn";i:1;}', 1, 0.00, 1371958687),
...
(147, '£ ', 'SDG', '%i', 'Sudanese pound', 0, 1.00000, '', 0, 0.00, 0),
...
(180, 'ZK ', 'ZMK', '%i', 'Zambian kwacha', 0, 1.00000, '', 0, 0.00, 0),
(181, 'Z$', 'ZWD', '%i', 'Zimbabwean dollar', 0, 1.00000, '', 0, 0.00, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_discount`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_discount` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_download`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_download` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_download`
--

INSERT INTO `v2o6t_hikashop_download` (`file_id`, `order_id`, `file_pos`, `download_number`) VALUES
(28, 14, 1, 1),
(28, 16, 1, 1);
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_entry`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_entry` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_field`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_field` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_field`
--

INSERT INTO `v2o6t_hikashop_field` (`field_id`, `field_table`, `field_realname`, `field_namekey`, `field_type`, `field_value`, `field_published`, `field_ordering`, `field_options`, `field_core`, `field_required`, `field_backend`, `field_frontcomp`, `field_default`, `field_backend_listing`, `field_access`, `field_categories`, `field_with_sub_categories`) VALUES
(1, 'address', 'Title', 'address_title', 'singledropdown', 'Mr::HIKA_TITLE_MR\nMrs::HIKA_TITLE_MRS\nMiss::HIKA_TITLE_MISS\nMs::HIKA_TITLE_MS\nDr::HIKA_TITLE_DR', 1, 1, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(2, 'address', 'Firstname', 'address_firstname', 'text', '', 1, 2, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(3, 'address', 'Middle name', 'address_middle_name', 'text', '', 0, 3, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(4, 'address', 'Lastname', 'address_lastname', 'text', '', 1, 4, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(5, 'address', 'Company', 'address_company', 'text', '', 0, 5, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(6, 'address', 'Street', 'address_street', 'text', '', 1, 6, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(7, 'address', 'Complement', 'address_street2', 'text', '', 0, 7, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(8, 'address', 'Post code', 'address_post_code', 'text', '', 1, 8, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(9, 'address', 'City', 'address_city', 'text', '', 1, 9, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(10, 'address', 'Telephone', 'address_telephone', 'text', '', 1, 10, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, '', 0, 'all', 'all', 0),
(11, 'address', 'Telephone', 'address_telephone2', 'text', '', 0, 11, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(12, 'address', 'Fax', 'address_fax', 'text', '', 0, 12, 'a:5:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0),
(13, 'address', 'State', 'address_state', 'zone', '', 1, 13, 'a:6:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:9:"zone_type";s:5:"state";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, 'state_Rh__ne_1375', 0, 'all', 'all', 0),
(14, 'address', 'Country', 'address_country', 'zone', '', 1, 14, 'a:6:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:9:"zone_type";s:7:"country";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 1, 1, 1, 'country_France_73', 0, 'all', 'all', 0),
(15, 'address', 'VAT number', 'address_vat', 'text', '', 0, 15, 'a:6:{s:12:"errormessage";s:0:"";s:4:"cols";s:0:"";s:4:"rows";s:0:"";s:9:"zone_type";s:7:"country";s:4:"size";s:0:"";s:6:"format";s:0:"";}', 1, 0, 1, 1, '', 0, 'all', 'all', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_file`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_file` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_file`
--

INSERT INTO `v2o6t_hikashop_file` (`file_id`, `file_name`, `file_description`, `file_path`, `file_type`, `file_ref_id`, `file_free_download`, `file_ordering`, `file_limit`) VALUES
(1, '', '', 'videojuegos.jpg', 'category', 12, 0, 0, 0),
(2, '', '', 'unsolved_crimes.jpg', 'category', 13, 0, 0, 0),
(3, '', '', 'videojuegos-2.jpg', 'category', 14, 0, 0, 0),
(4, '', '', 'juguetes.jpg', 'category', 15, 0, 0, 0),
(5, '', '', 'accesorios.jpg', 'category', 16, 0, 0, 0),
(26, '', '', 'pokemonazul.rar', 'file', 6, 0, 0, -1),
(20, '', '', 'xbox360elite.jpg', 'product', 3, 0, 0, 0),
(19, '', '', 'wii.jpg', 'product', 2, 0, 0, 0),
(25, '', '', 'azul-caratula.jpg', 'product', 6, 0, 0, 0),
(24, 'PokemonAmarillo', '', 'pokemonamarillo.rar', 'file', 5, 0, 0, -1),
(22, 'PokemonRojoFuego', '', 'pokemonrojo.rar', 'file', 4, 0, 0, -1),
(21, '', '', 'rojo-caratula.jpg', 'product', 4, 0, 0, 0),
(23, '', '', 'caratula_pokmon_amarillo.jpg', 'product', 5, 0, 0, 0),
(18, '', '', 'ps4.jpg', 'product', 1, 0, 0, 0),
(27, '', '', 'rojo-caratula_5149.jpg', 'product', 7, 0, 0, 0),
(28, 'PokemonRojoGuia', '', 'pokemonrojo_1569.rar', 'file', 7, 0, 0, -1),
(29, '', '', 'caratula_pokmon_amarillo_29703.jpg', 'product', 0, 0, 0, 0),
(30, 'PokemonAmarilloGuia', '', 'pokemonamarillo_11360.rar', 'file', 0, 0, 0, -1),
(31, '', '', 'azul-caratula_11916.jpg', 'product', 9, 0, 0, 0),
(32, 'PokemonAzulGuia', '', 'pokemonazul_21714.rar', 'file', 9, 0, 0, -1),
(33, '', '', 'caratula_pokmon_amarillo_10123.jpg', 'product', 8, 0, 0, 0),
(34, 'PokemonAmarilloGuia', '', 'pokemonamarillo_20347.rar', 'file', 8, 0, 0, -1),
(35, '', '', 'mario.jpg', 'product', 10, 0, 0, 0),
(36, '', '', 'yoshi.jpg', 'product', 11, 0, 0, 0),
(37, '', '', 'halo.jpg', 'product', 12, 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_filter`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_filter` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_geolocation`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_geolocation` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_history`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_history` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_history`
--

INSERT INTO `v2o6t_hikashop_history` (`history_id`, `history_order_id`, `history_created`, `history_ip`, `history_new_status`, `history_reason`, `history_notified`, `history_amount`, `history_package_id`, `history_payment_id`, `history_payment_method`, `history_data`, `history_type`, `history_user_id`) VALUES
(31, 14, 1372268561, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(29, 13, 1372268236, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(30, 14, 1372268552, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(28, 13, 1372268236, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(27, 12, 1372268109, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(26, 12, 1372268109, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(25, 11, 1372268067, '127.0.0.1', 'confirmed', 'asdasd', 1, '', 0, '', '', '', 'modification', 1),
(24, 11, 1372268001, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(23, 11, 1372268001, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(22, 10, 1372267887, '127.0.0.1', 'confirmed', 'jjkhjkhhjk', 1, '', 0, '', '', '', 'modification', 1),
(21, 10, 1372267782, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(20, 10, 1372267782, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(32, 14, 1372268628, '127.0.0.1', 'confirmed', 'holo', 1, '', 0, '', '', '', 'modification', 1),
(33, 14, 1372268633, '127.0.0.1', 'confirmed', 'holo', 1, '', 0, '', '', '', 'modification', 1),
(34, 14, 1372268634, '127.0.0.1', 'confirmed', 'holo', 1, '', 0, '', '', '', 'modification', 1),
(35, 15, 1372269353, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(36, 15, 1372269361, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(37, 16, 1372269435, '127.0.0.1', 'created', 'Compra creada', 0, '', 0, '', '', '', 'creation', 1),
(38, 16, 1372269444, '127.0.0.1', 'created', '', 0, '', 0, '', '', '', '', 1),
(39, 16, 1372269525, '127.0.0.1', 'confirmed', 'gracias por su compra', 1, '', 0, '', '', '', 'modification', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_limit`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_limit` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_order`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_order` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_order`
--

INSERT INTO `v2o6t_hikashop_order` (`order_id`, `order_billing_address_id`, `order_shipping_address_id`, `order_user_id`, `order_status`, `order_discount_code`, `order_created`, `order_ip`, `order_currency_id`, `order_shipping_price`, `order_discount_price`, `order_shipping_id`, `order_shipping_method`, `order_payment_id`, `order_payment_method`, `order_full_price`, `order_modified`, `order_partner_id`, `order_partner_price`, `order_partner_paid`, `order_type`, `order_partner_currency_id`, `order_shipping_tax`, `order_discount_tax`, `order_number`, `order_invoice_id`, `order_invoice_number`, `order_tax_info`, `order_payment_price`, `order_invoice_created`) VALUES
(16, 1, 1, 1, 'confirmed', '', 1372269435, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 80.00000, 1372269525, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'S16', 4, 'E4', 'a:0:{}', 0.00000, 1372269525),
(15, 1, 1, 1, 'created', '', 1372269353, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 4500.00000, 1372269361, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'R15', 0, '', 'a:0:{}', 0.00000, 0),
(14, 1, 1, 1, 'confirmed', '', 1372268552, '127.0.0.1', 1, 0.00000, 0.00000, '', '', '3', 'banktransfer', 80.00000, 1372268634, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'Q14', 3, 'D3', 'a:0:{}', 0.00000, 1372268628),
(13, 1, 1, 1, 'created', '', 1372268236, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 80.00000, 1372268236, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'P13', 0, '', 'a:0:{}', 0.00000, 0),
(12, 1, 1, 1, 'created', '', 1372268109, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 3000.00000, 1372268109, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'N12', 0, '', 'a:0:{}', 0.00000, 0),
(11, 1, 1, 1, 'confirmed', '', 1372268001, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 160.00000, 1372268067, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'M11', 2, 'C2', 'a:0:{}', 0.00000, 1372268067),
(10, 1, 1, 1, 'confirmed', '', 1372267782, '127.0.0.1', 100, 0.00000, 0.00000, '', '', '3', 'banktransfer', 7500.00000, 1372267887, 0, 0.00000, 0, 'sale', 0, 0.00000, 0.00000, 'L10', 1, 'B1', 'a:0:{}', 0.00000, 1372267887);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_order_product`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_order_product` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_order_product`
--

INSERT INTO `v2o6t_hikashop_order_product` (`order_product_id`, `order_id`, `product_id`, `order_product_quantity`, `order_product_name`, `order_product_code`, `order_product_price`, `order_product_tax`, `order_product_options`, `order_product_option_parent_id`, `order_product_tax_info`, `order_product_wishlist_id`) VALUES
(18, 12, 2, 1, 'Wii', 'Wii', 3000.00000, 0.00000, '', 0, 'a:0:{}', 0),
(19, 13, 9, 1, 'Pokemon Azul Guia', 'Pokemon_Azul_Guia', 80.00000, 0.00000, '', 0, 'a:0:{}', 0),
(17, 11, 8, 1, 'Pokemon Amarillo Guia', 'Pokemon_Amarillo_Guia', 80.00000, 0.00000, '', 0, 'a:0:{}', 0),
(16, 11, 9, 1, 'Pokemon Azul Guia', 'Pokemon_Azul_Guia', 80.00000, 0.00000, '', 0, 'a:0:{}', 0),
(15, 10, 3, 1, 'XBox 360', 'XBox_360', 4500.00000, 0.00000, '', 0, 'a:0:{}', 0),
(14, 10, 2, 1, 'Wii', 'Wii', 3000.00000, 0.00000, '', 0, 'a:0:{}', 0),
(13, 10, 1, 1, 'PS4', 'PS4', 0.00000, 0.00000, '', 0, '', 0),
(20, 14, 7, 1, 'Pokemon Rojo Guia', 'Pokemon_Rojo_Guia', 80.00000, 0.00000, '', 0, 'a:0:{}', 0),
(21, 15, 3, 1, 'XBox 360', 'XBox_360', 4500.00000, 0.00000, '', 0, 'a:0:{}', 0),
(22, 16, 7, 1, 'Pokemon Rojo Guia', 'Pokemon_Rojo_Guia', 80.00000, 0.00000, '', 0, 'a:0:{}', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_payment`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_payment` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_payment`
--

INSERT INTO `v2o6t_hikashop_payment` (`payment_id`, `payment_name`, `payment_description`, `payment_images`, `payment_params`, `payment_type`, `payment_zone_namekey`, `payment_access`, `payment_shipping_methods`, `payment_currency`, `payment_price`) VALUES
(1, 'PayPal', 'You can pay by credit card or paypal using this payment method', 'MasterCard,VISA,Credit_card,PayPal', 'O:8:"stdClass":8:{s:3:"url";s:37:"https://www.paypal.com/cgi-bin/webscr";s:12:"notification";i:1;s:3:"ips";s:0:"";s:7:"details";i:0;s:14:"invalid_status";s:9:"cancelled";s:14:"pending_status";s:7:"created";s:15:"verified_status";s:9:"confirmed";s:16:"address_override";i:1;}', 'paypal', '', 'all', '', '', 0.00000),
(2, 'HSBC', 'You can pay by credit card using this payment method', 'MasterCard,VISA,Credit_card,American_Express', 'O:8:"stdClass":3:{s:14:"invalid_status";s:9:"cancelled";s:14:"pending_status";s:7:"created";s:15:"verified_status";s:9:"confirmed";}', 'hsbc', '', 'all', '', '', 0.00000),
(3, 'Bank transfer', '<p>You can pay by sending us a bank transfer.</p>', 'Bank_transfer', 'O:8:"stdClass":5:{s:16:"payment_currency";s:1:"1";s:18:"payment_percentage";s:1:"0";s:12:"order_status";s:7:"created";s:18:"status_notif_email";s:1:"0";s:11:"information";s:421:"Account owner:09460418<br/>\r\n<br/>\r\nOwner address:<br/>\r\n<br/>\r\nAnd. Guerra del salitre 911<br/>\r\n<br/>\r\nVillas de San Sebastian<br/>\r\n<br/>\r\nIBAN International Bank Account Number:<br/>\r\n<br/>\r\nXXXX XXXX XXXX XXXX XXXX XXXX XXX<br/>\r\n<br/>\r\nBIC swift Bank Identification Code:<br/>\r\n<br/>\r\nXXXXXXXXXXXXXX<br/>\r\n<br/>\r\nBank name: JosBank<br/>\r\n<br/>\r\nBank address:<br/>\r\n<br/>\r\nFilomeno Medina<br/>\r\n<br/>\r\nXXXXX XXXXXXXX";}', 'banktransfer', '', 'all', '', '', 0.00000);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_price`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_price` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_price`
--

INSERT INTO `v2o6t_hikashop_price` (`price_id`, `price_currency_id`, `price_product_id`, `price_value`, `price_min_quantity`, `price_access`) VALUES
(1, 100, 1, 1000.00000, 9500, 'all'),
(2, 100, 2, 3000.00000, 0, 'all'),
(3, 100, 3, 4500.00000, 0, 'all'),
(4, 100, 4, 250.00000, 0, 'all'),
(5, 100, 5, 250.00000, 0, 'all'),
(6, 100, 6, 250.00000, 0, 'all'),
(7, 100, 7, 80.00000, 0, 'all'),
(8, 100, 8, 80.00000, 0, 'all'),
(9, 100, 9, 80.00000, 0, 'all'),
(10, 100, 10, 300.00000, 0, 'all'),
(11, 100, 11, 250.00000, 0, 'all'),
(12, 100, 12, 250.00000, 0, 'all');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_product`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_product` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_product`
--

INSERT INTO `v2o6t_hikashop_product` (`product_id`, `product_parent_id`, `product_name`, `product_description`, `product_quantity`, `product_code`, `product_published`, `product_hit`, `product_created`, `product_sale_start`, `product_sale_end`, `product_delay_id`, `product_tax_id`, `product_type`, `product_vendor_id`, `product_manufacturer_id`, `product_url`, `product_weight`, `product_keywords`, `product_weight_unit`, `product_modified`, `product_meta_description`, `product_dimension_unit`, `product_width`, `product_length`, `product_height`, `product_max_per_order`, `product_access`, `product_group_after_purchase`, `product_min_per_order`, `product_contact`, `product_last_seen_date`, `product_sales`, `product_waitlist`, `product_layout`, `product_average_score`, `product_total_vote`, `product_page_title`, `product_alias`, `product_price_percentage`, `product_msrp`, `product_canonical`) VALUES
(1, 0, 'PS4', '<p>Ultima tecnología de la gama PlayStation la cual tenemos consolas limitadas. APROBECHA!</p>\r\n<p> <span style="background-color: #fcfcfc; font-family: tahoma, arial, helvetica, sans-serif; font-size: 13px; line-height: normal;">{mosmap width=''500''|height=''400''|lat=''32.43021,-116.487073''|lon=''4.447141''| zoom=''3''|zoomType=''Large''|zoomNew=''0''|mapType=''Sat ellite''|showMaptype=''1''| overview=''0''|</span></p>', -1, 'PS4', 1, 12, 1372046742, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372094917, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372268089, 2, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(2, 0, 'Wii', '<p class="MsoNormal">Es una videoconsola producida por Nintendo y estrenada el 19 de noviembre de 2006 en Norteamérica y el 8 de diciembre del mismo año en Europa. Perteneciente a la séptima generación de consolas,9 es la sucesora directa de Nintendo GameCube y compite principalmente con los sistemas Xbox 360 de Microsoft y PlayStation 3 de Sony</p>', -1, 'Wii', 1, 0, 1372047051, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047051, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 0, 3, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(3, 0, 'XBox 360', '<p class="MsoNormal">Xbox 360 es la segunda videoconsola de sobremesa producida por Microsoft. Fue desarrollada en colaboración con IBM y ATI y lanzada en América del Norte, Japón, Europa y Australia entre 2005 y 2006. Su servicio Xbox Live permite a los jugadores competir en línea y descargar contenidos como juegos arcade, demos, tráilers, programa de televisión y películas.</p>', -1, 'XBox_360', 1, 1, 1372047153, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047153, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372098891, 3, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(4, 0, 'Pokemon Rojo ', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Rojo_', 1, 0, 1372047429, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047429, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 0, 0, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(5, 0, 'Pokemon Amarillo', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Amarillo', 1, 1, 1372047540, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047540, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372096968, 1, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(6, 0, 'Pokemon Azul', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Azul', 1, 3, 1372047626, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047626, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372099269, 0, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(7, 0, 'Pokemon Rojo Guia', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Rojo_Guia', 1, 0, 1372047722, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372048017, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 0, 2, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(8, 0, 'Pokemon Amarillo Guia', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Amarillo_Guia', 1, 1, 1372047872, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372048002, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372267397, 3, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(9, 0, 'Pokemon Azul Guia', '<p class="MsoNormal">son las versiones reeditadas de los juegos originales de Pokémon Rojo y Azul (Rojo y Verde en Japón), con las novedades de los juegos para Game Boy Advance de Pokémon Rubí, Zafiro y Esmeralda. Ambas ediciones fueron lanzadas a las tiendas europeas el 1 de Octubre de 2004. Aunque estas ediciones sean los remakes de Pokémon Rojo y Verde, se consideran de la Tercera generación, incluían además un Conector inalámbrico.</p>', -1, 'Pokemon_Azul_Guia', 1, 1, 1372047947, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372047947, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372267544, 3, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(10, 0, 'Mario Bross', '<p>El unico juguerte de Mario Bross disponible para ti completamente</p>\r\n<p> </p>', -1, 'Mario_Bross', 1, 2, 1372048093, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372048964, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 1372097088, 2, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(11, 0, 'Yoshi', '<p>El Unico juguete de Yoshi completamente Original!!</p>', -1, 'Yoshi', 1, 0, 1372048140, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372048140, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 0, 1, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, ''),
(12, 0, 'Master Cheaf', '<p>De el famoso videojuego Halo tenemos el Master Cheaf unico y original</p>', -1, 'Master_Cheaf', 1, 0, 1372048205, 0, 0, 0, 11, 'main', 0, 0, '', 0.000, '', 'kg', 1372048205, '', 'm', 0.000, 0.000, 0.000, 0, 'all', '', 0, 0, 0, 1, 0, '', 0, 0, '', '', 0.0000000, 0.0000000, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_product_category`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_product_category` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_product_category`
--

INSERT INTO `v2o6t_hikashop_product_category` (`product_category_id`, `category_id`, `product_id`, `ordering`) VALUES
(1, 12, 1, 1),
(2, 12, 2, 2),
(3, 12, 3, 3),
(4, 14, 4, 1),
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_product_related`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_product_related` (
  `product_id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_product_related`
--

INSERT INTO `v2o6t_hikashop_product_related` (`product_id`, `product_related_id`, `product_related_type`, `product_related_ordering`) VALUES
(5, 4, 'related', 0),
(6, 4, 'related', 0),
(6, 5, 'related', 0),
(7, 4, 'related', 0),
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_shipping`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_shipping` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_shipping_price`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_shipping_price` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_tax`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_tax` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_taxation`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_taxation` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_user`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_user` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_user`
--

INSERT INTO `v2o6t_hikashop_user` (`user_id`, `user_cms_id`, `user_email`, `user_partner_email`, `user_params`, `user_partner_id`, `user_partner_price`, `user_partner_paid`, `user_created_ip`, `user_unpaid_amount`, `user_partner_currency_id`, `user_created`, `user_currency_id`, `user_partner_activated`) VALUES
(1, 701, 'josue226@gmail.com', '', '', 0, 0.00000, 0, '', 0.00000, 0, 1371930509, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_hikashop_variant`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_variant` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_vote`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_vote` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_vote_user`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_vote_user` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_waitlist`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_waitlist` (
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_widget`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_widget` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_widget`
--

INSERT INTO `v2o6t_hikashop_widget` (`widget_id`, `widget_name`, `widget_params`, `widget_published`, `widget_ordering`, `widget_access`) VALUES
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_zone`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_zone` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4556 ;

--
-- Volcado de datos para la tabla `v2o6t_hikashop_zone`
--

INSERT INTO `v2o6t_hikashop_zone` (`zone_id`, `zone_namekey`, `zone_name`, `zone_name_english`, `zone_code_2`, `zone_code_3`, `zone_type`, `zone_published`, `zone_currency_id`) VALUES
...
(237, 'country_Zaire_237', 'Zaire', 'Zaire', 'ZR', 'ZAR', 'country', 1, 0),
...
(632, 'state_______________________________________632', 'Брэ́сцкая во́бласць', 'Брэ́сцкая во́бласць', '', 'BR', 'state', 1, 0),
(633, 'state___________________________________________633', 'Го́мельская во́бласць', 'Го́мельская во́бласць', '', 'HO', 'state', 1, 0),
(634, 'state_____________________________________________634', 'Гро́дзенская во́бласць', 'Гро́дзенская во́бласць', '', 'HR', 'state', 1, 0),
(635, 'state___________________________________________635', 'Магілёўская во́бласць', 'Магілёўская во́бласць', '', 'MA', 'state', 1, 0),
(636, 'state_____________________________________636', 'Мі́нская во́бласць', 'Мі́нская во́бласць', '', 'MI', 'state', 1, 0),
(637, 'state_________________________________________637', 'Ві́цебская во́бласць', 'Ві́цебская во́бласць', '', 'VI', 'state', 1, 0),
(638, 'state_Brussel_638', 'Brussel', 'Brussel', '', 'BRU', 'state', 1, 0),
(639, 'state_Antwerpen_639', 'Antwerpen', 'Antwerpen', '', 'VAN', 'state', 1, 0),
(640, 'state_Vlaams_Brabant_640', 'Vlaams-Brabant', 'Vlaams-Brabant', '', 'VBR', 'state', 1, 0),
(641, 'state_Limburg_641', 'Limburg', 'Limburg', '', 'VLI', 'state', 1, 0),
(642, 'state_Oost_Vlaanderen_642', 'Oost-Vlaanderen', 'Oost-Vlaanderen', '', 'VOV', 'state', 1, 0),
(643, 'state_West_Vlaanderen_643', 'West-Vlaanderen', 'West-Vlaanderen', '', 'VWV', 'state', 1, 0),
(644, 'state_Brabant_Wallon_644', 'Brabant Wallon', 'Brabant Wallon', '', 'WBR', 'state', 1, 0),
(645, 'state_Hainaut_645', 'Hainaut', 'Hainaut', '', 'WHT', 'state', 1, 0),
(646, 'state_Li__ge_L__ttich_646', 'Liège/Lüttich', 'Liège/Lüttich', '', 'WLG', 'state', 1, 0),
(647, 'state_Luxembourg_647', 'Luxembourg', 'Luxembourg', '', 'WLX', 'state', 1, 0),
(648, 'state_Namur_648', 'Namur', 'Namur', '', 'WNA', 'state', 1, 0),
...
(1119, 'state_Bornholms_Regionskommune_1119', 'Bornholms Regionskommune', 'Bornholms Regionskommune', '', '040', 'state', 1, 0),
(1120, 'state_K__benhavn_1120', 'København', 'København', '', '101', 'state', 1, 0),
(1121, 'state_Frederiksberg_1121', 'Frederiksberg', 'Frederiksberg', '', '147', 'state', 1, 0),
(1122, 'state___rhus_Amt_1122', 'Århus Amt', 'Århus Amt', '', '070', 'state', 1, 0),
(1123, 'state_K__benhavns_Amt_1123', 'Københavns Amt', 'Københavns Amt', '', '015', 'state', 1, 0),
(1124, 'state_Frederiksborg_Amt_1124', 'Frederiksborg Amt', 'Frederiksborg Amt', '', '020', 'state', 1, 0),
(1125, 'state_Fyns_Amt_1125', 'Fyns Amt', 'Fyns Amt', '', '042', 'state', 1, 0),
(1126, 'state_Nordjyllands_Amt_1126', 'Nordjyllands Amt', 'Nordjyllands Amt', '', '080', 'state', 1, 0),
(1127, 'state_Ribe_Amt_1127', 'Ribe Amt', 'Ribe Amt', '', '055', 'state', 1, 0),
(1128, 'state_Ringkj__bing_Amt_1128', 'Ringkjøbing Amt', 'Ringkjøbing Amt', '', '065', 'state', 1, 0),
(1129, 'state_Roskilde_Amt_1129', 'Roskilde Amt', 'Roskilde Amt', '', '025', 'state', 1, 0),
(1130, 'state_S__nderjyllands_Amt_1130', 'Sønderjyllands Amt', 'Sønderjyllands Amt', '', '050', 'state', 1, 0),
(1131, 'state_Storstr__ms_Amt_1131', 'Storstrøms Amt', 'Storstrøms Amt', '', '035', 'state', 1, 0),
(1132, 'state_Vejle_Amt_1132', 'Vejle Amt', 'Vejle Amt', '', '060', 'state', 1, 0),
(1133, 'state_Vestsj__llands_Amt_1133', 'Vestsjællands Amt', 'Vestsjællands Amt', '', '030', 'state', 1, 0),
(1134, 'state_Viborg_Amt_1134', 'Viborg Amt', 'Viborg Amt', '', '076', 'state', 1, 0),
...
(1233, 'state___________________________1233', 'محافظة المنيا', 'محافظة المنيا', '', 'MN', 'state', 1, 0),
(1234, 'state__________________1234', 'المنوفية', 'المنوفية', '', 'MNF', 'state', 1, 0),
(1235, 'state____________1235', 'مطروح', 'مطروح', '', 'MT', 'state', 1, 0),
(1236, 'state______________________________1236', 'محافظة بور سعيد', 'محافظة بور سعيد', '', 'PTS', 'state', 1, 0),
(1237, 'state_________________________1237', 'محافظة سوهاج', 'محافظة سوهاج', '', 'SHG', 'state', 1, 0),
(1238, 'state___________________________________1238', 'المحافظة الشرقيّة', 'المحافظة الشرقيّة', '', 'SHR', 'state', 1, 0),
...
(1710, 'state_________________________________________________________________1710', 'अंडमान और निकोबार द्वीप', 'अंडमान और निकोबार द्वीप', '', 'IN-AN', 'state', 1, 0),
(1711, 'state_______________________________________1711', 'ఆంధ్ర ప్రదేశ్', 'ఆంధ్ర ప్రదేశ్', '', 'IN-AP', 'state', 1, 0),
(1712, 'state__________________________________________1712', 'अरुणाचल प्रदेश', 'अरुणाचल प्रदेश', '', 'IN-AR', 'state', 1, 0),
(1713, 'state___________1713', 'অসম', 'অসম', '', 'IN-AS', 'state', 1, 0),
(1714, 'state_________________1714', 'बिहार', 'बिहार', '', 'IN-BR', 'state', 1, 0);
INSERT INTO `v2o6t_hikashop_zone` (`zone_id`, `zone_namekey`, `zone_name`, `zone_name_english`, `zone_code_2`, `zone_code_3`, `zone_type`, `zone_published`, `zone_currency_id`) VALUES
(1715, 'state_______________________1715', 'चंडीगढ़', 'चंडीगढ़', '', 'IN-CH', 'state', 1, 0),
(1716, 'state_____________________________1716', 'छत्तीसगढ़', 'छत्तीसगढ़', '', 'IN-CT', 'state', 1, 0),
(1717, 'state_______________________________1717', 'દમણ અને દિવ', 'દમણ અને દિવ', '', 'IN-DD', 'state', 1, 0),
(1718, 'state____________________1718', 'दिल्ली', 'दिल्ली', '', 'IN-DL', 'state', 1, 0),
(1719, 'state_____________________________________________________1719', 'દાદરા અને નગર હવેલી', 'દાદરા અને નગર હવેલી', '', 'IN-DN', 'state', 1, 0),
(1720, 'state______________1720', 'गोंय', 'गोंय', '', 'IN-GA', 'state', 1, 0),
(1721, 'state____________________1721', 'ગુજરાત', 'ગુજરાત', '', 'IN-GJ', 'state', 1, 0),
(1722, 'state_______________________________________1722', 'हिमाचल प्रदेश', 'हिमाचल प्रदेश', '', 'IN-HP', 'state', 1, 0),
(1723, 'state_______________________1723', 'हरियाणा', 'हरियाणा', '', 'IN-HR', 'state', 1, 0),
(1724, 'state____________________1724', 'झारखंड', 'झारखंड', '', 'IN-JH', 'state', 1, 0),
(1725, 'state___________________________________________1725', 'जम्मू और कश्मीर', 'जम्मू और कश्मीर', '', 'IN-JK', 'state', 1, 0),
(1726, 'state____________________1726', 'ಕನಾ೯ಟಕ', 'ಕನಾ೯ಟಕ', '', 'IN-KA', 'state', 1, 0),
(1727, 'state_________________1727', 'കേരളം', 'കേരളം', '', 'IN-KL', 'state', 1, 0),
(1728, 'state________________________________1728', 'ലക്ഷദ്വീപ്', 'ലക്ഷദ്വീപ്', '', 'IN-LD', 'state', 1, 0),
(1729, 'state____________________1729', 'मेघालय', 'मेघालय', '', 'IN-ML', 'state', 1, 0),
(1730, 'state________________________________1730', 'महाराष्ट्र', 'महाराष्ट्र', '', 'IN-MH', 'state', 1, 0),
(1731, 'state____________________1731', 'मणिपुर', 'मणिपुर', '', 'IN-MN', 'state', 1, 0),
(1732, 'state_________________________________1732', 'मध्य प्रदेश', 'मध्य प्रदेश', '', 'IN-MP', 'state', 1, 0),
(1733, 'state_______________________1733', 'मिज़ोरम', 'मिज़ोरम', '', 'IN-MZ', 'state', 1, 0),
(1734, 'state__________________________1734', 'नागालैंड', 'नागालैंड', '', 'IN-NL', 'state', 1, 0),
(1735, 'state____________________1735', 'उड़ीसा', 'उड़ीसा', '', 'IN-OR', 'state', 1, 0),
(1736, 'state_________________1736', 'ਪੰਜਾਬ', 'ਪੰਜਾਬ', '', 'IN-PB', 'state', 1, 0),
(1737, 'state________________________________1737', 'புதுச்சேரி', 'புதுச்சேரி', '', 'IN-PY', 'state', 1, 0),
(1738, 'state__________________________1738', 'राजस्थान', 'राजस्थान', '', 'IN-RJ', 'state', 1, 0),
(1739, 'state_______________________1739', 'सिक्किम', 'सिक्किम', '', 'IN-SK', 'state', 1, 0),
(1740, 'state______________________________1740', 'தமிழ் நாடு', 'தமிழ் நாடு', '', 'IN-TN', 'state', 1, 0),
(1741, 'state__________________________1741', 'ত্রিপুরা', 'ত্রিপুরা', '', 'IN-TR', 'state', 1, 0),
(1742, 'state_____________________________1742', 'उत्तरांचल', 'उत्तरांचल', '', 'IN-UL', 'state', 1, 0),
(1743, 'state____________________________________1743', 'उत्तर प्रदेश', 'उत्तर प्रदेश', '', 'IN-UP', 'state', 1, 0),
(1744, 'state________________________________1744', 'পশ্চিমবঙ্গ', 'পশ্চিমবঙ্গ', '', 'IN-WB', 'state', 1, 0),
...
(1775, 'state__________________________________________1775', 'محافظة آذربایجان شرقي', 'محافظة آذربایجان شرقي', '', '01', 'state', 1, 0),
(1776, 'state__________________________________________1776', 'محافظة آذربایجان غربي', 'محافظة آذربایجان غربي', '', '02', 'state', 1, 0),
(1777, 'state___________________________1777', 'محافظة اردبیل', 'محافظة اردبیل', '', '03', 'state', 1, 0),
(1778, 'state___________________________1778', 'محافظة اصفهان', 'محافظة اصفهان', '', '04', 'state', 1, 0),
(1779, 'state_________________________1779', 'محافظة ایلام', 'محافظة ایلام', '', '05', 'state', 1, 0),
(1780, 'state_________________________1780', 'محافظة بوشهر', 'محافظة بوشهر', '', '06', 'state', 1, 0),
(1781, 'state_________________________1781', 'محافظة طهران', 'محافظة طهران', '', '07', 'state', 1, 0),
(1782, 'state_______________________________________________1782', 'محافظة چهارمحل و بختیاري', 'محافظة چهارمحل و بختیاري', '', '08', 'state', 1, 0),
(1783, 'state____________________________________1783', 'محافظة خراسان رضوي', 'محافظة خراسان رضوي', '', '09', 'state', 1, 0),
(1784, 'state_____________________________1784', 'محافظة خوزستان', 'محافظة خوزستان', '', '10', 'state', 1, 0),
...
(1792, 'state____________________________________________________1792', 'محافظة کهکیلویه و بویر أحمد', 'محافظة کهکیلویه و بویر أحمد', '', '18', 'state', 1, 0),
(1793, 'state_________________________1793', 'محافظة گیلان', 'محافظة گیلان', '', '19', 'state', 1, 0),
(1794, 'state___________________________1794', 'محافظة لرستان', 'محافظة لرستان', '', '20', 'state', 1, 0),
(1795, 'state_______________________________1795', 'محافظة مازندران', 'محافظة مازندران', '', '21', 'state', 1, 0),
(1796, 'state_________________________1796', 'محافظة مرکزي', 'محافظة مرکزي', '', '22', 'state', 1, 0),
(1797, 'state_____________________________1797', 'محافظة هرمزگان', 'محافظة هرمزگان', '', '23', 'state', 1, 0),
(1798, 'state_________________________1798', 'محافظة همدان', 'محافظة همدان', '', '24', 'state', 1, 0),
(1799, 'state_____________________1799', 'محافظة یزد', 'محافظة یزد', '', '25', 'state', 1, 0),
(1800, 'state___________________1800', 'محافظة قم', 'محافظة قم', '', '26', 'state', 1, 0),
(1801, 'state___________________________1801', 'محافظة گلستان', 'محافظة گلستان', '', '27', 'state', 1, 0),
(1802, 'state_________________________1802', 'محافظة قزوين', 'محافظة قزوين', '', '28', 'state', 1, 0),
(1803, 'state_____________________________1803', 'محافظة الأنبار', 'محافظة الأنبار', '', 'AN', 'state', 1, 0),
(1804, 'state____________1804', 'أربيل', 'أربيل', '', 'AR', 'state', 1, 0),
(1805, 'state___________________________1805', 'محافظة البصرة', 'محافظة البصرة', '', 'BA', 'state', 1, 0),
(1806, 'state__________1806', 'بابل', 'بابل', '', 'BB', 'state', 1, 0),
(1807, 'state_________________________1807', 'محافظة بغداد', 'محافظة بغداد', '', 'BG', 'state', 1, 0),
...
(1818, 'state___________________________________1818', 'محافظة السليمانية', 'محافظة السليمانية', '', 'SW', 'state', 1, 0),
...
(1837, 'state_Muineach__n_1837', 'Muineachán', 'County Monaghan', '', 'MN', 'state', 1, 0),
...
(1856, 'state_Valle_d_Aosta_1856', 'Valle d''Aosta', 'Valle d''Aosta', '', 'AO', 'state', 1, 0),
...
(1871, 'state_Alto_Adige_1871', 'Alto Adige', 'Alto Adige', '', 'BZ', 'state', 1, 0),
...
(1977, 'state___________1977', '北海道', '北海道', '', '01', 'state', 1, 0),
(1978, 'state________1978', '青森県', '青森県', '', '02', 'state', 1, 0),
(1979, 'state________1979', '岩手県', '岩手県', '', '03', 'state', 1, 0),
(1980, 'state________1980', '宮城県', '宮城県', '', '04', 'state', 1, 0),
(1981, 'state________1981', '秋田県', '秋田県', '', '05', 'state', 1, 0),
(1982, 'state________1982', '山形県', '山形県', '', '06', 'state', 1, 0),
(1983, 'state________1983', '福島県', '福島県', '', '07', 'state', 1, 0),
(1984, 'state________1984', '茨城県', '茨城県', '', '08', 'state', 1, 0),
(1985, 'state________1985', '栃木県', '栃木県', '', '09', 'state', 1, 0),
(1986, 'state________1986', '群馬県', '群馬県', '', '10', 'state', 1, 0),
(1987, 'state________1987', '埼玉県', '埼玉県', '', '11', 'state', 1, 0),
(1988, 'state________1988', '千葉県', '千葉県', '', '12', 'state', 1, 0),
(1989, 'state________1989', '東京都', '東京都', '', '13', 'state', 1, 0),
(1990, 'state___________1990', '神奈川県', '神奈川県', '', '14', 'state', 1, 0),
(1991, 'state________1991', '新潟県', '新潟県', '', '15', 'state', 1, 0),
(1992, 'state________1992', '富山県', '富山県', '', '16', 'state', 1, 0),
(1993, 'state________1993', '石川県', '石川県', '', '17', 'state', 1, 0),
(1994, 'state________1994', '福井県', '福井県', '', '18', 'state', 1, 0),
(1995, 'state________1995', '山梨県', '山梨県', '', '19', 'state', 1, 0),
(1996, 'state________1996', '長野県', '長野県', '', '20', 'state', 1, 0),
(1997, 'state________1997', '岐阜県', '岐阜県', '', '21', 'state', 1, 0),
(1998, 'state________1998', '静岡県', '静岡県', '', '22', 'state', 1, 0),
(1999, 'state________1999', '愛知県', '愛知県', '', '23', 'state', 1, 0),
(2000, 'state________2000', '三重県', '三重県', '', '24', 'state', 1, 0),
(2001, 'state________2001', '滋賀県', '滋賀県', '', '25', 'state', 1, 0),
(2002, 'state________2002', '京都府', '京都府', '', '26', 'state', 1, 0),
(2003, 'state________2003', '大阪府', '大阪府', '', '27', 'state', 1, 0),
(2004, 'state________2004', '兵庫県', '兵庫県', '', '28', 'state', 1, 0),
(2005, 'state________2005', '奈良県', '奈良県', '', '29', 'state', 1, 0),
(2006, 'state___________2006', '和歌山県', '和歌山県', '', '30', 'state', 1, 0),
(2007, 'state________2007', '鳥取県', '鳥取県', '', '31', 'state', 1, 0),
(2008, 'state________2008', '島根県', '島根県', '', '32', 'state', 1, 0),
(2009, 'state________2009', '岡山県', '岡山県', '', '33', 'state', 1, 0),
(2010, 'state________2010', '広島県', '広島県', '', '34', 'state', 1, 0),
(2011, 'state________2011', '山口県', '山口県', '', '35', 'state', 1, 0),
(2012, 'state________2012', '徳島県', '徳島県', '', '36', 'state', 1, 0),
(2013, 'state________2013', '香川県', '香川県', '', '37', 'state', 1, 0),
(2014, 'state________2014', '愛媛県', '愛媛県', '', '38', 'state', 1, 0),
(2015, 'state________2015', '高知県', '高知県', '', '39', 'state', 1, 0),
(2016, 'state________2016', '福岡県', '福岡県', '', '40', 'state', 1, 0),
(2017, 'state________2017', '佐賀県', '佐賀県', '', '41', 'state', 1, 0),
(2018, 'state________2018', '長崎県', '長崎県', '', '42', 'state', 1, 0),
(2019, 'state________2019', '熊本県', '熊本県', '', '43', 'state', 1, 0),
(2020, 'state________2020', '大分県', '大分県', '', '44', 'state', 1, 0),
(2021, 'state________2021', '宮崎県', '宮崎県', '', '45', 'state', 1, 0),
(2022, 'state___________2022', '鹿児島県', '鹿児島', '', '46', 'state', 1, 0),
(2023, 'state________2023', '沖縄県', '沖縄県', '', '47', 'state', 1, 0),
(2024, 'state_________________________2024', 'محافظة عجلون', 'محافظة عجلون', '', 'AJ', 'state', 1, 0),
(2025, 'state_____________________________2025', 'محافظة العاصمة', 'محافظة العاصمة', '', 'AM', 'state', 1, 0),
(2026, 'state___________________________2026', 'محافظة العقبة', 'محافظة العقبة', '', 'AQ', 'state', 1, 0),
(2027, 'state_____________________________2027', 'محافظة الطفيلة', 'محافظة الطفيلة', '', 'AT', 'state', 1, 0),
(2028, 'state_____________________________2028', 'محافظة الزرقاء', 'محافظة الزرقاء', '', 'AZ', 'state', 1, 0),
(2029, 'state_____________________________2029', 'محافظة البلقاء', 'محافظة البلقاء', '', 'BA', 'state', 1, 0),
(2030, 'state_____________________2030', 'محافظة جرش', 'محافظة جرش', '', 'JA', 'state', 1, 0),
(2031, 'state_______________________2031', 'محافظة إربد', 'محافظة إربد', '', 'JR', 'state', 1, 0),
(2032, 'state_________________________2032', 'محافظة الكرك', 'محافظة الكرك', '', 'KA', 'state', 1, 0),
(2033, 'state___________________________2033', 'محافظة المفرق', 'محافظة المفرق', '', 'MA', 'state', 1, 0),
(2034, 'state_________________________2034', 'محافظة مادبا', 'محافظة مادبا', '', 'MD', 'state', 1, 0),
(2035, 'state_______________________2035', 'محافظة معان', 'محافظة معان', '', 'MN', 'state', 1, 0),
...
(2826, 'state_Cocl___2826', 'Coclé', 'Coclé', '', '2', 'state', 1, 0),
(2827, 'state_Col__n_2827', 'Colón', 'Colón', '', '3', 'state', 1, 0),
(2828, 'state_Chiriqu___2828', 'Chiriquí', 'Chiriquí', '', '4', 'state', 1, 0),
(2829, 'state_Dari__n_2829', 'Darién', 'Darién', '', '5', 'state', 1, 0),
(2830, 'state_Herrera_2830', 'Herrera', 'Herrera', '', '6', 'state', 1, 0),
(2831, 'state_Los_Santos_2831', 'Los Santos', 'Los Santos', '', '7', 'state', 1, 0),
(2832, 'state_Panam___2832', 'Panamá', 'Panamá', '', '8', 'state', 1, 0),
(2833, 'state_Veraguas_2833', 'Veraguas', 'Veraguas', '', '9', 'state', 1, 0),
(2834, 'state_Kuna_Yala_2834', 'Kuna Yala', 'Kuna Yala', '', 'Q', 'state', 1, 0),
...
(3066, 'state_____________________________________________________________________________3066', 'Агинский-Бурятский автономный округ', 'Агинский-Бурятский автономный округ', '', 'AGB', 'state', 1, 0),
...
(3078, 'state_______________________________________3078', 'Читинская область', 'Читинская область', '', 'CHI', 'state', 1, 0),
...
(3082, 'state______________________________________________________________3082', 'Эвенкийский автономный округ', 'Эвенкийский автономный округ', '', 'EVE', 'state', 1, 0),
...
(3086, 'state_________________________________________3086', 'Камчатская область', 'Камчатская область', '', 'KAM', 'state', 1, 0),
...
(3095, 'state_____________________________________3095', 'Красноярский край', 'Красноярский край', '', 'KIA', 'state', 1, 0),
(3096, 'state_______________________________________3096', 'Кировская область', 'Кировская область', '', 'KIR', 'state', 1, 0),
(3097, 'state__________________3097', 'Хакасия', 'Хакасия', '', 'KK', 'state', 1, 0),
...
(3101, 'state__________________________________________________________3101', 'Корякский автономный округ', 'Корякский автономный округ', '', 'KOR', 'state', 1, 0),
...
(3134, 'state_____________________________________________3134', 'Республика Татарстан', 'Республика Татарстан', '', 'TA', 'state', 1, 0),
(3135, 'state_________________________________________3135', 'Тамбовская область', 'Тамбовская область', '', 'TAM', 'state', 1, 0),
(3136, 'state____________________________________________________________3136', 'Таймырский автономный округ', 'Таймырский автономный округ', '', 'TAY', 'state', 1, 0),
...
(3144, 'state________________________________________________________________________________________3144', 'Усть-Ордынский Бурятский автономный округ', 'Усть-Ордынский Бурятский автономный округ', '', 'UOB', 'state', 1, 0),
...
(3149, 'state_____________________________3149', 'Пермский край', 'Пермский край', '', 'XXX', 'state', 1, 0),
...
(4445, 'state_S__i_G__n_4445', 'Sài Gòn', 'Sài Gòn', '', '65', 'state', 1, 0),
...
--
-- Estructura de tabla para la tabla `v2o6t_hikashop_zone_link`
--

CREATE TABLE IF NOT EXISTS `v2o6t_hikashop_zone_link` (
...
--
-- Volcado de datos para la tabla `v2o6t_hikashop_zone_link`
--

INSERT INTO `v2o6t_hikashop_zone_link` (`zone_parent_namekey`, `zone_child_namekey`) VALUES
...
--
-- Estructura de tabla para la tabla `v2o6t_languages`
--

CREATE TABLE IF NOT EXISTS `v2o6t_languages` (
...
--
-- Volcado de datos para la tabla `v2o6t_languages`
--

INSERT INTO `v2o6t_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Estructura de tabla para la tabla `v2o6t_menu`
--

CREATE TABLE IF NOT EXISTS `v2o6t_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_menu`
--

INSERT INTO `v2o6t_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(16, 'menu', 'com_redirect', 'Redireccionar', '', 'Redireccionar', 'index.php?option=com_redirect', 'component', 0, 1, 1, 24, 0, '0000-00-00 00:00:00', 0, 0, 'class:redirect', 0, '', 43, 44, 0, '*', 1),
...
(101, 'mainmenu', 'Inicio', 'inicio', '', 'inicio', 'index.php?option=com_hikashop&view=category&layout=listing', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":1,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 29, 30, 1, '*', 0),
(102, 'hikashop_default', 'Categories listing', 'hikashop-menu-for-categories-listing', '', 'hikashop-menu-for-categories-listing', 'index.php?option=com_hikashop&view=category&layout=listing', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(103, 'hikashop_default', 'Products listing', 'hikashop-menu-for-products-listing', '', 'hikashop-menu-for-products-listing', 'index.php?option=com_hikashop&view=product&layout=listing', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"show_page_title":1}', 47, 48, 0, '*', 0),
(104, 'hikashop_default', 'User control panel', 'hikashop-menu-for-user-control-panel', '', 'hikashop-menu-for-user-control-panel', 'index.php?option=com_hikashop&view=user&layout=cpanel', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_page_title":1}', 49, 50, 0, '*', 0),
(105, 'hikashop_default', 'Registration form', 'hikashop-menu-for-hikashop-registration', '', 'hikashop-menu-for-hikashop-registration', 'index.php?option=com_hikashop&view=user&layout=form', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 7, '{"show_page_title":1}', 51, 52, 0, '*', 0),
(106, 'hikashop_default', 'Brands listing', 'hikashop-menu-for-brands-listing', '', 'hikashop-menu-for-brands-listing', 'index.php?option=com_hikashop&view=category&layout=listing', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_page_title":1}', 53, 54, 0, '*', 0),
(107, 'main', 'HikaShop', 'hikashop', '', 'hikashop', 'index.php?option=com_hikashop', 'component', 0, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '../media/com_hikashop/images/icons/icon-16-hikashop.png', 0, '', 55, 72, 0, '', 1),
(108, 'menu', 'Products', 'Products', '', 'hikashop/Products', 'index.php?option=com_hikashop&ctrl=product', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-article.png', 0, '', 56, 57, 0, '*', 1),
(109, 'menu', 'Categories', 'Categories', '', 'hikashop/Categories', 'index.php?option=com_hikashop&ctrl=category&filter_id=product', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-category.png', 0, '', 58, 59, 0, '*', 1),
(110, 'menu', 'Users', 'Users', '', 'hikashop/Users', 'index.php?option=com_hikashop&ctrl=user&filter_partner=0', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-user.png', 0, '', 60, 61, 0, '*', 1),
(111, 'menu', 'Orders', 'Orders', '', 'hikashop/Orders', 'index.php?option=com_hikashop&ctrl=order&order_type=sale&filter_partner=0', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-content.png', 0, '', 62, 63, 0, '*', 1),
(112, 'menu', 'Configuration', 'Configuration', '', 'hikashop/Configuration', 'index.php?option=com_hikashop&ctrl=config', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-config.png', 0, '', 64, 65, 0, '*', 1),
(113, 'menu', 'Discounts', 'Discounts', '', 'hikashop/Discounts', 'index.php?option=com_hikashop&ctrl=discount', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-default.png', 0, '', 66, 67, 0, '*', 1),
(114, 'menu', 'Help', 'Help', '', 'hikashop/Help', 'index.php?option=com_hikashop&ctrl=documentation', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-help.png', 0, '', 68, 69, 0, '*', 1),
(115, 'menu', 'Update / About', 'Update / About', '', 'hikashop/Update / About', 'index.php?option=com_hikashop&ctrl=update', 'component', 0, 107, 2, 10000, 0, '0000-00-00 00:00:00', 0, 0, './templates/bluestork/images/menu/icon-16-help-jrd.png', 0, '', 70, 71, 0, '*', 1),
(116, 'hikashop_default', 'Hola', 'hola', '', 'hola', 'index.php?option=com_hikashop&view=product&layout=listing', 'component', -2, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 73, 74, 0, '*', 0),
(117, 'hikashop_default', 'Quienes somos?', 'quienes-somos', '', 'quienes-somos', 'index.php?option=com_contact&view=categories&id=0', 'component', 1, 1, 1, 8, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_base_description":"","categories_description":"","maxLevelcat":"","show_empty_categories_cat":"","show_subcat_desc_cat":"","show_cat_items_cat":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_subcat_desc":"","show_cat_items":"","show_pagination_limit":"","show_headings":"","show_position_headings":"","show_email_headings":"","show_telephone_headings":"","show_mobile_headings":"","show_fax_headings":"","show_suburb_headings":"","show_state_headings":"","show_country_headings":"","show_pagination":"","show_pagination_results":"","presentation_style":"","show_contact_category":"","show_contact_list":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_links":"","linka_name":"","linkb_name":"","linkc_name":"","linkd_name":"","linke_name":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":"","show_feed_link":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 75, 76, 0, '*', 0),
(118, 'mainmenu', 'Mision Vision Valores', 'holas', '', 'holas', 'index.php?option=com_content&view=article&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 77, 78, 0, '*', 0),
(119, 'mainmenu', '¿Quienes somos?', 'quienes', '', 'quienes', 'index.php?option=com_content&view=article&id=3', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 79, 80, 0, '*', 0),
(120, 'hikashop_default', 'Pago', 'pago', '', 'pago', 'index.php?option=com_hikashop&view=checkout&layout=step', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 81, 82, 0, '*', 0),
(121, 'mainmenu', 'PagoS', 'pagos', '', 'pagos', 'index.php?option=com_hikashop&view=product&layout=contact', 'component', -2, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 83, 84, 0, '*', 0),
(122, 'mainmenu', 'Condiciones de compras', 'condicion', '', 'condicion', 'index.php?option=com_content&view=article&id=4', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 85, 86, 0, '*', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_menu_types`
--

CREATE TABLE IF NOT EXISTS `v2o6t_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_menu_types`
--

INSERT INTO `v2o6t_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Menú principal', 'El menú principal del sitio'),
(2, 'hikashop_default', 'HikaShop default menus', 'This menu is used by HikaShop to store menus configurations');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_messages`
--

CREATE TABLE IF NOT EXISTS `v2o6t_messages` (
...
--
-- Estructura de tabla para la tabla `v2o6t_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `v2o6t_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `v2o6t_modules`
--

CREATE TABLE IF NOT EXISTS `v2o6t_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_modules`
--

INSERT INTO `v2o6t_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(17, 'Ruta', '', '', 1, 'position-2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_breadcrumbs', 1, 1, '{"moduleclass_sfx":"","showHome":"1","homeText":"Inicio","showComponent":"1","separator":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(87, 'Associated products listing for category listing menu 102', '', '', 0, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 0, 0, '', 0, ''),
(88, 'Associated products listing for category listing menu 103', '', '', 0, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 0, 0, '', 0, ''),
(89, 'Associated products listing for manufacturer listing menu 106', '', '', 0, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 0, 0, '', 0, ''),
(90, 'Random products', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(91, 'Recently viewed', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(92, 'Categories on 1 level', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(93, 'Categories on 2 levels', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(94, 'Best sellers', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(95, 'Latest products', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(96, 'Brands', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(97, 'Best rated', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(98, 'Related products', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_hikashop', 1, 1, '', 0, '*'),
(99, 'HikaShop Content Module', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_hikashop', 1, 1, '', 0, '*'),
(100, 'HikaShop Cart Module', '', '', 0, 'position-7', 701, '2013-06-24 18:22:52', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_hikashop_cart', 1, 1, '', 0, '*'),
(101, 'HikaShop Currency Switcher Module', '', '', 0, 'position-7', 701, '2013-06-23 05:05:43', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_hikashop_currency', 1, 1, '', 0, '*'),
(102, 'Hola', '', '', 0, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_menu', 1, 1, '{"menutype":"hikashop_default","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(103, 'Associated products listing for category listing menu 101', '', '', 0, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_hikashop', 0, 0, '', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_modules_menu`
--

CREATE TABLE IF NOT EXISTS `v2o6t_modules_menu` (
...
--
-- Volcado de datos para la tabla `v2o6t_modules_menu`
--

INSERT INTO `v2o6t_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `v2o6t_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `v2o6t_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `v2o6t_overrider`
--

CREATE TABLE IF NOT EXISTS `v2o6t_overrider` (
...
--
-- Estructura de tabla para la tabla `v2o6t_redirect_links`
--

CREATE TABLE IF NOT EXISTS `v2o6t_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_redirect_links`
--

INSERT INTO `v2o6t_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://localhost/joomla/index.php/holas', '', 'http://localhost/joomla/', '', 2, 0, '2013-06-24 17:36:47', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_schemas`
--

CREATE TABLE IF NOT EXISTS `v2o6t_schemas` (
...
--
-- Volcado de datos para la tabla `v2o6t_schemas`
--

INSERT INTO `v2o6t_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.3');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_session`
--

CREATE TABLE IF NOT EXISTS `v2o6t_session` (
...
--
-- Volcado de datos para la tabla `v2o6t_session`
--

INSERT INTO `v2o6t_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('57kjbhldoptbp4fehh21t846s3', 1, 0, '1372269535', '__default|a:8:{s:15:"session.counter";i:11;s:19:"session.timer.start";i:1372268602;s:18:"session.timer.last";i:1372269478;s:17:"session.timer.now";i:1372269524;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.116 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:12:"com_hikashop";O:8:"stdClass":1:{s:5:"order";O:8:"stdClass":1:{s:14:"filter_partner";i:0;}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"701";s:4:"name";s:13:"Super Usuario";s:8:"username";s:5:"Josue";s:5:"email";s:18:"josue226@gmail.com";s:8:"password";s:65:"ed97cb670ae7f9f6e81f298b9036e11a:qCHVy6GCFJy1RXUlEBjyz4rS9eTzsSnS";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-06-22 19:45:41";s:13:"lastvisitDate";s:19:"2013-06-26 17:42:28";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"b58a297b7bf2f58d0e02eb177efa49c4";}', 701, 'Josue'),
('fe92m8g8hnmitstvrta5ctrhk1', 0, 0, '1372269563', '__default|a:9:{s:15:"session.counter";i:33;s:19:"session.timer.start";i:1372268527;s:18:"session.timer.last";i:1372269435;s:17:"session.timer.now";i:1372269563;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.116 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:12:"com_hikashop";O:8:"stdClass":25:{s:12:"ssl_redirect";i:0;s:7:"zone_id";s:4:"2538";s:7:"cart_id";i:0;s:15:"shipping_method";s:0:"";s:11:"shipping_id";s:0:"";s:13:"shipping_data";s:0:"";s:8:"cart_new";s:1:"1";s:14:"payment_method";s:12:"banktransfer";s:10:"payment_id";i:3;s:12:"payment_data";O:8:"stdClass":28:{s:10:"payment_id";s:1:"3";s:12:"payment_name";s:13:"Bank transfer";s:19:"payment_description";s:49:"<p>You can pay by sending us a bank transfer.</p>";s:14:"payment_images";s:13:"Bank_transfer";s:14:"payment_params";O:8:"stdClass":5:{s:16:"payment_currency";s:1:"1";s:18:"payment_percentage";s:1:"0";s:12:"order_status";s:7:"created";s:18:"status_notif_email";s:1:"0";s:11:"information";s:421:"Account owner:09460418<br/>\r\n<br/>\r\nOwner address:<br/>\r\n<br/>\r\nAnd. Guerra del salitre 911<br/>\r\n<br/>\r\nVillas de San Sebastian<br/>\r\n<br/>\r\nIBAN International Bank Account Number:<br/>\r\n<br/>\r\nXXXX XXXX XXXX XXXX XXXX XXXX XXX<br/>\r\n<br/>\r\nBIC swift Bank Identification Code:<br/>\r\n<br/>\r\nXXXXXXXXXXXXXX<br/>\r\n<br/>\r\nBank name: JosBank<br/>\r\n<br/>\r\nBank address:<br/>\r\n<br/>\r\nFilomeno Medina<br/>\r\n<br/>\r\nXXXXX XXXXXXXX";}s:12:"payment_type";s:12:"banktransfer";s:20:"payment_zone_namekey";s:0:"";s:14:"payment_access";s:3:"all";s:24:"payment_shipping_methods";s:0:"";s:16:"payment_currency";s:0:"";s:13:"payment_price";d:0;s:12:"extension_id";s:5:"10012";s:4:"name";s:37:"HikaShop bank transfer payment plugin";s:4:"type";s:6:"plugin";s:7:"element";s:12:"banktransfer";s:6:"folder";s:15:"hikashoppayment";s:9:"client_id";s:1:"0";s:7:"enabled";s:1:"1";s:6:"access";s:1:"1";s:9:"protected";s:1:"0";s:14:"manifest_cache";s:0:"";s:6:"params";s:0:"";s:11:"custom_data";s:0:"";s:11:"system_data";s:0:"";s:11:"checked_out";s:1:"0";s:16:"checked_out_time";s:19:"0000-00-00 00:00:00";s:8:"ordering";s:1:"0";s:5:"state";s:1:"0";}s:16:"shipping_address";i:1;s:15:"billing_address";i:1;s:7:"user_id";i:1;s:18:"checkout_fields_ok";i:0;s:8:"order_id";i:16;s:11:"coupon_code";s:0:"";s:9:"cc_number";s:0:"";s:8:"cc_month";s:0:"";s:7:"cc_year";s:0:"";s:6:"cc_CCV";s:0:"";s:8:"cc_owner";s:0:"";s:8:"cc_valid";i:0;s:14:"checkout_terms";i:0;s:15:"checkout_fields";N;s:11:"currency_id";i:100;}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"701";s:4:"name";s:13:"Super Usuario";s:8:"username";s:5:"Josue";s:5:"email";s:18:"josue226@gmail.com";s:8:"password";s:65:"ed97cb670ae7f9f6e81f298b9036e11a:qCHVy6GCFJy1RXUlEBjyz4rS9eTzsSnS";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-06-22 19:45:41";s:13:"lastvisitDate";s:19:"2013-06-26 17:20:48";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"4fb58d5bbaf5eba540929f2b6bc52639";s:16:"com_mailto.links";a:3:{s:40:"a9961dcf76c01c0d2839b448b3f1172e05ce5b62";O:8:"stdClass":2:{s:4:"link";s:41:"http://localhost/joomla/index.php/quienes";s:6:"expiry";i:1372268909;}s:40:"7dd729b4ed1fa24e610540eab0ae699bda2885ee";O:8:"stdClass":2:{s:4:"link";s:39:"http://localhost/joomla/index.php/holas";s:6:"expiry";i:1372269037;}s:40:"b353e69ab0e59d2c8c85421b9b54c070f40ff748";O:8:"stdClass":2:{s:4:"link";s:43:"http://localhost/joomla/index.php/condicion";s:6:"expiry";i:1372269146;}}}ck_submital|a:4:{s:34:"[b5b4a4bbdaeb62464a4caae7c2485483]";b:1;s:34:"[05e2abc9d7244d24e7b03feb7b4e7a1b]";b:1;s:34:"[80ef290b569fb399e4709e4bfee5501d]";b:1;s:34:"[4e14bec4777594ef787ab8e31dc749b2]";b:1;}', 701, 'Josue');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_template_styles`
--

CREATE TABLE IF NOT EXISTS `v2o6t_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `v2o6t_template_styles`
--

INSERT INTO `v2o6t_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
(7, 'protostar', 0, '1', 'protostar - Predeterminada', '{"templateColor":"#08C","templateBackgroundColor":"#F4F6F7","logoFile":"images\\/cropped-TECHOP-01.png","sitetitle":"TeChop","sitedescription":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Predeterminada', '{"templateColor":"","logoFile":""}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_updates`
--

CREATE TABLE IF NOT EXISTS `v2o6t_updates` (
...
--
-- Volcado de datos para la tabla `v2o6t_updates`
--

INSERT INTO `v2o6t_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(5, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.1.1.3', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', ''),
...
(17, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.1.1.2', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', ''),
(18, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(19, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
...
(22, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(23, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(24, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(25, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(26, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(27, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(28, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(29, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(30, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(31, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(32, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(33, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', ''),
(34, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(35, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(36, 3, 0, 'Scottish Gaelic', '', 'pkg_gd-GB', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/gd-GB_details.xml', ''),
(37, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(38, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(39, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(40, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(41, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(42, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
(43, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', ''),
(44, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
...
(47, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(48, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(49, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(50, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(51, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(52, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(53, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.1.0.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(54, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', ''),
(55, 5, 0, 'Google Maps', 'Plugin Googlemap for showing Google Maps in your Joomla website', 'plugin_googlemap2', 'plugin', 'system', 0, '3.0', '', 'http://tech.reumer.net/update/plugin_googlemap3/extension.xml', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_update_sites`
--

CREATE TABLE IF NOT EXISTS `v2o6t_update_sites` (
...
--
-- Volcado de datos para la tabla `v2o6t_update_sites`
--

INSERT INTO `v2o6t_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1372267975),
(2, 'Directorio de Extensiones Joomla', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1372267975),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1372267975),
(4, 'Hikashop', 'extension', 'http://www.hikashop.com/component/updateme/updatexml/component-hikashop/level-Starter/file-extension.xml', 1, 1372267975),
(5, 'Plugin Googlemap Update Site', 'extension', 'http://tech.reumer.net/update/plugin_googlemap3/extension.xml', 1, 1372267975);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `v2o6t_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `v2o6t_update_sites_extensions`
--

INSERT INTO `v2o6t_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 10000),
...
--
-- Estructura de tabla para la tabla `v2o6t_usergroups`
--

CREATE TABLE IF NOT EXISTS `v2o6t_usergroups` (
...
--
-- Volcado de datos para la tabla `v2o6t_usergroups`
--

INSERT INTO `v2o6t_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Publico'),
(2, 1, 8, 15, 'Registrado'),
(3, 2, 9, 14, 'Autor'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `v2o6t_users`
--

CREATE TABLE IF NOT EXISTS `v2o6t_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `v2o6t_users`
--

INSERT INTO `v2o6t_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(701, 'Super Usuario', 'Josue', 'josue226@gmail.com', 'ed97cb670ae7f9f6e81f298b9036e11a:qCHVy6GCFJy1RXUlEBjyz4rS9eTzsSnS', 0, 1, '2013-06-22 19:45:41', '2013-06-26 17:43:28', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_user_notes`
--

CREATE TABLE IF NOT EXISTS `v2o6t_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `v2o6t_user_profiles`
--

CREATE TABLE IF NOT EXISTS `v2o6t_user_profiles` (
...
--
-- Estructura de tabla para la tabla `v2o6t_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `v2o6t_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `v2o6t_user_usergroup_map`
--

INSERT INTO `v2o6t_user_usergroup_map` (`user_id`, `group_id`) VALUES
(701, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `v2o6t_viewlevels`
--

CREATE TABLE IF NOT EXISTS `v2o6t_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `v2o6t_viewlevels`
--

INSERT INTO `v2o6t_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Publico', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `v2o6t_weblinks`
--

CREATE TABLE IF NOT EXISTS `v2o6t_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
